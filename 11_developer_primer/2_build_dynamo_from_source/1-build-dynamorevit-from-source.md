...
I file di origine di DynamoRevit sono inoltre ospitati sulla pagina di DynamoDS su GitHub per consentire agli sviluppatori di apportare contributi e compilare versioni beta. La compilazione di DynamoRevit dalla sorgente segue generalmente lo stesso processo di Dynamo, ad eccezione di alcuni dettagli importanti:
...
* DynamoRevit è specifico delle versioni di Revit, ad esempio: il ramo di DynamoRevit 2018 deve essere eseguito in Revit 2018.
...
La sorgente di DynamoRevit è ospitata qui: [https://github.com/DynamoDS/DynamoRevit](https://github.com/DynamoDS/DynamoRevit).

![DynamoRevit su GitHub](../../.gitbook/assets/github-dynamorevit.jpg)
...
![Interfaccia della riga di comando](../../.gitbook/assets/cli-cd-revit.jpg)
...
![Interfaccia della riga di comando dopo la clonazione del repository](../../.gitbook/assets/cli-clone-revit.jpg)
...
![Directory convertita in un ramo](../../.gitbook/assets/cli-branch-revit.jpg)
...
### Compilazione del repository mediante Visual Studio <a href="#building-dynamo-revit" id="building-dynamo-revit"></a>
...
![Esegui come amministratore](../../.gitbook/assets/fe-restorepackages.jpg)
...
![I pacchetti NuGet di Dynamo della versione beta più recenti](../../.gitbook/assets/fe-packages.jpg)
...
![Creazione di una soluzione](../../.gitbook/assets/vs-build-dynamorevit.jpg)
...
![Cartelle DynamoForRevit e DynamoPlayerforRevit](../../.gitbook/assets/fe-dynamo-folders-remove.jpg)
...
![Il nodo Wall.ByCurbeAndHeight che genera un'eccezione](../../.gitbook/assets/dyn-wallbycurveandheight.jpg)

> 1. Il nodo Wall.ByCurveAndHeight che genera un'eccezione

Iniziare aprendo il file della soluzione `DynamoRevit.All.sln`, avviare Revit e il modulo aggiuntivo DynamoRevit. Quindi, associare Visual Studio al processo di Revit con la finestra `Attach to Process`.

![Finestra Attach to Process](../../.gitbook/assets/vs-debug-attachprocess.jpg)
...
![Impostazione di un punto di interruzione](../../.gitbook/assets/vs-debugging-breakpoint.jpg)
...
![Punto di interruzione rilevato in Visual Studio](../../.gitbook/assets/vs-breakpoint.jpg)
...
![Eseguire un'istruzione in Visual Studio](../../.gitbook/assets/vs-stepover.jpg)
...
![Eccezione in Visual Studio](../../.gitbook/assets/vs-exception.jpg)
...
Questo processo può essere applicato a qualsiasi file di origine utilizzato. Se si sta sviluppando una libreria di nodi zero-touch per Dynamo, è possibile aprire l'origine della libreria e associare un processo di Dynamo per eseguire il debug della libreria dei nodi. Anche se tutto funziona perfettamente, il debug è un ottimo modo per esplorare il codice e scoprire come funziona.
...
![Impostazione di una directory nell'interfaccia della riga di comando](../../.gitbook/assets/cli-pull-revit.jpg)
...
Come indicato in **Creazione di Dynamo dalla sorgente**, quando si è pronti per inviare una modifica al repository di DynamoRevit, è possibile creare una richiesta pull seguendo le linee guida del team di Dynamo riportate nella sezione Richieste pull.
