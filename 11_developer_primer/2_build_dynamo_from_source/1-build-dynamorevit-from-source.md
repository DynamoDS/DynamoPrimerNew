...
`cd C:\Users\username\Documents\GitHub\DynamoRevit` cambia el directorio a DynamoRevit.\
 ...
 `git branch` comprueba en qué ramificación se encuentra y muestra las demás que existen localmente.
...
Este proceso se puede aplicar a cualquier archivo de código fuente con el que se trabaje. Al desarrollar una biblioteca de nodos Zero-Touch para Dynamo, podemos abrir el código fuente de la biblioteca y asociar un proceso de Dynamo para depurar la biblioteca de nodos. Aunque todo funcione perfectamente, la depuración es una excelente forma de explorar el código y descubrir el funcionamiento de los componentes.
