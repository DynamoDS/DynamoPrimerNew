...
![DynamoRevit sur GitHub](<../../.gitbook/assets/github-dynamorevit (1).jpg>)
...
![Interface de ligne de commande](<../../.gitbook/assets/cli-cd-revit (1).jpg>)
...
![Interface en ligne de commande après clonage du dépôt](<../../.gitbook/assets/cli-clone-revit (1).jpg>)

Une fois que le clonage du dépôt est terminé, changez le répertoire courant en dossier du dépôt et passez à la branche qui correspond à la version installée de Revit. Pour cet exemple, nous utilisons Revit RC2.13.1\_Revit2023. Toutes les branches distantes peuvent être consultées sur la page GitHub dans le menu déroulant Branche.
...
![Répertoire basculé vers une branche](<../../.gitbook/assets/cli-branch-revit (1).jpg>)
...
![Exécution en tant qu’Administrateur](<../../.gitbook/assets/fe-restorepackages (1).jpg>)
...
![La dernière version bêta des packages Dynamo NuGet](<../../.gitbook/assets/fe-packages (1).jpg>)
...
![Génération d’une solution](<../../.gitbook/assets/vs-build-dynamorevit (1).jpg>)
...
![Dossiers DynamoForRevit et DynamoPlayerforRevit](<../../.gitbook/assets/fe-dynamo-folders-remove (1).jpg>)
...
![Complément Dynamo situé dans l’onglet Gérer](<../../.gitbook/assets/revit-dynamo (1).jpg>)
...
![Le nœud Wall.ByCurveAndHeight levant une exception](<../../.gitbook/assets/dyn-wallbycurveandheight (1).jpg>)
...
![Fenêtre Attacher au processus](<../../.gitbook/assets/vs-debug-attachprocess (1).jpg>)
...
![Définition d’un point d’arrêt](<../../.gitbook/assets/vs-debugging-breakpoint (1).jpg>)
...
![Point d’arrêt atteint dans Visual Studio](<../../.gitbook/assets/vs-breakpoint (1).jpg>)
...
![Parcourir dans Visual Studio](<../../.gitbook/assets/vs-stepover (1).jpg>)
...
![Exception dans Visual Studio](<../../.gitbook/assets/vs-exception (1).jpg>)
...
![Définition d’un répertoire dans l’interface de ligne de commande](<../../.gitbook/assets/cli-pull-revit (1).jpg>)
