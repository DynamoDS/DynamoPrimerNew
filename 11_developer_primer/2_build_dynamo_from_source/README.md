...
Para obter instruções sobre como compilar o Dynamo para outras plataformas (por exemplo, Linux ou OS X), consulte esta [página wiki](https://github.com/DynamoDS/Dynamo/wiki/Dynamo-on-Linux,-Mac).
