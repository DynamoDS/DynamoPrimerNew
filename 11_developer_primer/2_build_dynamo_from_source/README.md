...
* 下载并安装 [Microsoft Visual Studio Community](https://visualstudio.microsoft.com/vs/community/)，这是一个功能齐全的免费 IDE（集成开发环境 - 更高版本也可以使用）
...
> **注意：** 重大变更 - [**Visual Studio 2022**](https://visualstudio.microsoft.com/vs/community/) **/** [**Visual Studio 2026 Insider**](https://visualstudio.microsoft.com/insiders/) 为必需
>
