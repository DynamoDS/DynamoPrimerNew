...
* Stáhněte a nainstalujte [Microsoft Visual Studio Community](https://visualstudio.microsoft.com/vs/community/), bezplatné, plně vybavené integrované vývojové prostředí (IDE –mohou fungovat i novější verze).
...
> **Poznámka:** Změna nekompatibilní se staršími verzemi – je vyžadována aplikace [**Visual Studio 2022**](https://visualstudio.microsoft.com/vs/community/) ** nebo ** [**Visual Studio 2026 Insider**](https://visualstudio.microsoft.com/insiders/).
>
> Od konce roku 2025 bude Dynamo implementovat rozhraní `dotnet10.0`. Pro vývoj v tomto rozhraní budete potřebovat aplikaci Visual Studio 2022 Preview nebo Visual Studio 2026 Insider (nebo novější), protože stabilní verze ještě nepodporují .NET 10.0.
>
> **Instalace aplikaci Visual Studio 2022 Preview/2026 Insider spolu se stávající instalací:**
>
> 1. Otevřete **instalační program pro Visual Studio** (vyhledejte ho v nabídce Start).
> 2. Kliknutím na tlačítko **Aktualizovat** se ujistěte, že máte nejnovější verzi instalačního programu.
> 3. Přejděte na kartu **Dostupné**.
