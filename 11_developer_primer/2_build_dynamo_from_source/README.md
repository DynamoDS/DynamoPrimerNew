...
![Les fichiers sources de Dynamo](<../../.gitbook/assets/github (1).jpg>)
...
![Clonage d’un dépôt](<../../.gitbook/assets/github-clone (1).png>)
...
![Invite de commande](<../../.gitbook/assets/cli-1 (1).jpg>)
...
![Résultats de l’opération de clonage de Git](<../../.gitbook/assets/cli-2 (1).jpg>)
...
![Fichiers source de Dynamo](<../../.gitbook/assets/source-files (1).jpg>)
...
![Ouverture du fichier solution](<../../.gitbook/assets/vs-open-dynamo (1).jpg>)
...
![Paramètres de la solution](<../../.gitbook/assets/vs-dynamo-build-settings (1).jpg>)
...
![Générer la solution](<../../.gitbook/assets/vs-build-dynamo (1).jpg>)
...
![Exécutable DynamoSandbox](<../../.gitbook/assets/ex-dynamosandbox (1).jpg>)
...
![Génération et démarrage d’une application à partir de Visual Studio](<../../.gitbook/assets/vs-debug-options (1).jpg>)
...
![Boîte de dialogue Attacher au processus](<../../.gitbook/assets/vs-attach-dynamosandbox (1).jpg>)
...
![Définition d’un point d’arrêt](<../../.gitbook/assets/vs-debug-dynamocore (1).jpg>)
...
![Mise à jour du dépôt local](<../../.gitbook/assets/cli-pull-changes (1).jpg>)
