...
![Исходные файлы Dynamo](../../.gitbook/assets/github.jpg)
...
Установите Git, прежде чем клонировать репозиторий. Это [краткое руководство](https://docs.github.com/ru/get-started/quickstart/set-up-git#setting-up-git) содержит инструкции по установке и настройке адреса электронной почты и имени пользователя на GitHub. В нашем примере мы будем использовать Git в командной строке. В этом руководстве предполагается, что вы работаете в Windows, но вы также можете использовать Git для клонирования исходных файлов Dynamo в macOS или Linux.
...
![Клонирование репозитория](../../.gitbook/assets/github-clone.png)
...
![Командная строка](../../.gitbook/assets/cli-1.jpg)

На следующем этапе мы выполним команду Git, чтобы клонировать хранилище Dynamo в указанную папку. URL-адрес в команде можно получить, нажав кнопку Clone or Download на GitHub. Выполните эту команду в командной строке терминала. Обратите внимание, что эта операция приведет к клонированию главной ветви репозитория Dynamo, где хранится последняя версия кода Dynamo. Эта ветвь меняется ежедневно.

`git clone https://github.com/DynamoDS/Dynamo.git`

![Результаты клонирования Git](../../.gitbook/assets/cli-2.jpg)
...
![Исходные файлы Dynamo](../../.gitbook/assets/source-files.jpg)
...
* Скачайте и установите [Microsoft Visual Studio Community](https://visualstudio.microsoft.com/vs/community/) — бесплатную полнофункциональную IDE (интегрированную среду разработки, допустимы поздние версии).
* Скачайте и установите [Microsoft .NET Framework 4.5](https://www.microsoft.com/ru-ru/download/details.aspx?id=30653) или более поздней версии.
...
> **Примечание.** Существенное изменение: требуется [**Visual Studio 2022**](https://visualstudio.microsoft.com/vs/community/) **или** [**Visual Studio 2026 Insider**](https://visualstudio.microsoft.com/insiders/).
>
...
![Открытие файла решения](../../.gitbook/assets/vs-open-dynamo.jpg)
...
![Параметры решения](../../.gitbook/assets/vs-dynamo-build-settings.jpg)
...
![Сборка решения](../../.gitbook/assets/vs-build-dynamo.jpg)
...
![Исполняемый файл DynamoSandbox](../../.gitbook/assets/ex-dynamosandbox.jpg)
...
![Создание и запуск приложения из Visual Studio](../../.gitbook/assets/vs-debug-options.jpg)
...
![Диалоговое окно «Присоединить к процессу»](../../.gitbook/assets/vs-attach-dynamosandbox.jpg)
...
![Установка точки прерывания](../../.gitbook/assets/vs-debug-dynamocore.jpg)
...
Поскольку исходный код Dynamo размещен на GitHub, проще всего обновлять локальные исходные файлы с помощью запросов на слияние с использованием команд Git.
...
![Обновленный локальный репозиторий](../../.gitbook/assets/cli-pull-changes.jpg)
...
* Создайте **вилку** репозитория Dynamo, чтобы получить копию, отдельную от оригинала. Внесенные здесь изменения не повлияют на исходный репозиторий, но мы можем извлекать обновления и отправлять запросы на слияние. Создание вилок — это не команда Git, а рабочий процесс, добавленный GitHub. Модель вилок и запросов на слияние — это один из самых популярных рабочих процессов для внесения вклада в проекты с открытым исходным кодом в интернете. Если вы хотите предложить улучшения для Dynamo, ознакомьтесь с этим методом.
