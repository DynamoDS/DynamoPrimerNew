...
![Búsqueda de paquetes](../images/dynamopackagemanager.png)
...
![Publicación de un paquete](../images/dyn-publish-package-add-files.png)
...
![Configuración del paquete](../images/dyn-publish-package.png)
