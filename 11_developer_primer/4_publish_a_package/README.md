...
![Поиск пакетов](../images/dynamopackagemanager.png)
...
![Публикация пакетов](../images/dyn-publish-package-add-files.png)
...
![Параметры пакета](../images/dyn-publish-package.png)
