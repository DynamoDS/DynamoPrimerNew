...
Les packages sont un moyen pratique de stocker et de partager des nœuds avec la communauté Dynamo. Un package peut contenir tout ce qui est nécessaire, des nœuds personnalisés créés dans l’espace de travail Dynamo aux nœuds dérivés de NodeModel. Les packages sont publiés et installés à l’aide du gestionnaire de package. En plus de cette page, le [guide](https://primer2.dynamobim.org/v/fr/6_custom_nodes_and_packages/6-2_packages/1-introduction) contient un guide général sur les packages.
...
![Package dans la bibliothèque Dynamo](<../../.gitbook/assets/dyn-publish-package-library (1).jpg>)
...
![Publier un package dans le gestionnaire de package](<../../.gitbook/assets/dyn-publish-package-directory (1).jpg>)
...
![Publier une version de package](<../../.gitbook/assets/dyn-publish-package-version (1).jpg>)
...
Le client Web du gestionnaire de package permet aux utilisateurs de rechercher et d’afficher les données des packages, y compris le contrôle des versions, les statistiques de téléchargement et d’autres informations pertinentes. En outre, les créateurs de packages peuvent se connecter pour mettre à jour les détails du package, tels que la compatibilité, directement via le client Web.
...
![Client Web du gestionnaire de package](<../../.gitbook/assets/packagemanager-browser (1).jpg>)
...
![Nouvelle interface utilisateur pour mettre à jour les détails des packages publiés](<../../.gitbook/assets/Package-Manager_Image_5 (1).png>)
...
![Modifier les informations de compatibilité des packages publiés - Étape 1](<../../.gitbook/assets/Package-Manager_Image_6 (1).png>)
...
![Quelle option choisir pour le workflow « Modifier les informations de compatibilité »](<../../.gitbook/assets/Package-Manager_Image_7 (1).png>)
...
![Modifier les options d’informations de compatibilité](<../../.gitbook/assets/Package-Manager_Image_8 (1).png>)

Selon l’option sélectionnée, les champs propres à Dynamo et/ou à l’hôte s’affichent, comme illustré sur l’image ci-dessous.

![Modifier les informations de compatibilité - Étape 2](<../../.gitbook/assets/Package-Manager_Image_9 (1).png>)
