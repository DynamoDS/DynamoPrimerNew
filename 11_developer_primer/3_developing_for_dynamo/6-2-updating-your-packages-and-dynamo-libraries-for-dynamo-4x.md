...
Il est très peu probable qu’un package créé pour Dynamo 4.x (_avec .Net 10_) fonctionne dans Dynamo 2.x. L’avertissement ci-dessous s’affiche également lorsque vous tentez d’installer des packages conçus pour Dynamo 4.x dans Dynamo 2.x.

#### Utilisation des packages Dynamo 4.x dans Dynamo 3.x

Un package créé pour Dynamo 4.x (_avec .Net 10_) peut fonctionner dans Dynamo 3.x tant que toutes les API utilisées dans le package existent sous .NET 8. Mais le fonctionnement n’est en aucun cas garanti. L’avertissement ci-dessous s’affiche également lorsque vous tentez d’installer des packages conçus pour Dynamo 4.x dans Dynamo 3.x.
