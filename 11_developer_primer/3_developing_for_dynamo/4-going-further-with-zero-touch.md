...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p>3인칭 동사로 설명을 시작합니다.</p><ul><li>예: <em>Determines</em> if one geometry object intersects with another</li></ul>                                                                                                                                                                                                                                                                                                                                                                                         | <p>2인칭 동사나 명사로 시작하지 마십시오.</p><ul><li>예: <em>Determine</em> if one geometry object intersects with another</li></ul>                                                                                                                                                                                                                                                      |
| <p>"Gets" 대신 "Returns", "Creates" 또는 다른 설명 동사를 사용합니다.</p><ul><li>예: <em>Returns</em> a Nurbs representation of a surface</li></ul>                                                                                                                                                                                                                                                                                                                                                                              | <p>"Get" 또는 "Gets"를 사용하지 마십시오. "Get" 또는 "Gets"는 덜 구체적이고 다양한 의미로 번역될 수 있습니다.</p><ul><li>예: <em>Gets</em> a Nurbs representation of the surface</li></ul>                                                                                                                                                                                                                                       |
| <p>입력을 언급할 때는 "specified" 또는 다른 용어 대신 "given" 또는 "input"을 사용합니다. 가능하면 "given" 또는 "input"을 생략하여 설명을 단순화하고 단어 수를 줄입니다.</p><ul><li>예: Deletes the <em>given</em> file</li><li>예: Projects a curve along the <em>given</em> projection direction onto <em>given</em> base geometry</li></ul><p>입력을 직접 언급하지 않을 때는 "specified"를 사용해도 됩니다.</p><ul><li>예: Writes text content to a file <em>specified</em> by the given path</li></ul> | <p>입력을 언급할 때 일관성을 유지하기 위해 "specified" 또는 다른 용어는 사용하지 말고 "given" 또는 "input"만 사용합니다. 명확성을 위해 필요한 경우를 제외하고 동일한 설명에서 "given"과 "input"을 혼용하지 마십시오.</p><ul><li>예: Deletes the <em>specified</em> file</li><li>예: Projects an <em>input</em> curve along a <em>given</em> projection direction onto a <em>specified</em> base geometry</li></ul> |
| <p>입력을 처음 언급할 때는 "a" 또는 "an"을 사용합니다. 명확성을 위해 필요에 따라 "a" 또는 "an" 대신 "the given" 또는 "the input"을 사용합니다.</p><ul><li>예: Sweeps <em>a</em> curve along the path curve</li></ul>                                                                                                                                                                                                                                                                                                                                | <p>입력을 처음 언급할 때 "this"를 사용하지 마십시오.</p><ul><li>예: Sweeps <em>this</em> curve along the path curve</li></ul>                                                                                                                                                                                                                                                                             |
| <p>노드 작업의 대상인 출력 또는 기타 명사를 처음 언급할 때 "a" 또는 "an"을 사용합니다. "the"는 "input" 또는 "given"과 짝을 이룰 때만 사용합니다.</p><ul><li>예: Copies <em>a</em> file</li><li>예: Copies <em>the given</em> file</li></ul>                                                                                                                                                                                                                                                                   | <p>노드 작업의 대상인 출력 또는 다른 명사를 처음 언급할 때 "the"만 단독으로 사용하지 마십시오.</p><ul><li>예: Copies <em>the</em> file</li></ul>                                                                                                                                                                                                                                  |
| <p>문장의 첫 번째 단어와 이름과 같은 고유명사 및 전통적으로 대문자로 쓰는 명사는 대문자로 씁니다.</p><ul><li>예: Returns the intersection of two <em>BoundingBoxes</em></li></ul>                                                                                                                                                                                                                                                                                                                                     | <p>일반적인 형상 객체 및 개념은 명확성을 위해 필요한 경우가 아니면 대문자로 쓰지 마십시오.</p><ul><li>예: Scales non-uniformly around the given <em>Plane</em></li></ul>                                                                                                                                                                                                                                          |
| <p>부울을 대문자로 씁니다. 부울의 출력을 언급할 때는 True 및 False를 대문자로 씁니다.</p><ul><li>예: Returns <em>true</em> if the two values are different</li><li>예: Converts a string to all uppercase or all lowercase characters based on a <em>Boolean</em> parameter</li></ul>                                                                                                                                                                                                                                        | <p>부울을 소문자로 쓰지 마십시오. 부울의 출력을 언급할 때 True 및 False를 소문자로 쓰지 마십시오.</p><ul><li>예: Returns <em>true</em> if the two values are different</li><li>예: Converts a string to all uppercase characters or all lowercase characters based on a <em>boolean</em> parameter</li></ul>                                                                                       |
