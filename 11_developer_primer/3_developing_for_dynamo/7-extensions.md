...
![Окно расширения вида](../../.gitbook/assets/dyn-viewextension.png)
...
Это основная информация о расширениях видов. Более сложный пример из практики можно найти в пакете DynaShape, проекте с открытым исходным кодом на GitHub. Пакет использует расширение вида, которое позволяет редактировать модель Dynamo в реальном времени.
