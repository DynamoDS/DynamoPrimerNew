...
![Un nœud Zero-Touch qui exécute une chaîne de script Python](<../../.gitbook/assets/python-case-study (1).png>)
...
![Ce nœud permet de renvoyer le volume du cuboïde et son centre de gravité.](<../../.gitbook/assets/python-multi-case-study (1).png>)
