...
* [Dynamo Revit 선택 노드 ](13-dynamo-integration.md#-dynamo-revit-selection-nodes) 사용자가 호스트에서 객체 또는 데이터를 선택하여 Dynamo 그래프에 입력으로 전달할 수 있는 노드를 구현하는 방법을 안내합니다.
...
직렬화된 base64 인코딩 데이터의 형식은 사용하지 _않는_ 것이 좋습니다.
