...
* [Узлы выбора Dynamo Revit](13-dynamo-integration.md#-dynamo-revit-selection-nodes): реализация узлов, которые позволяют пользователям выбирать объекты или данные из основного приложения и передавать их в качестве входных данных для графа Dynamo.
...
_НЕ_ рекомендуется задавать зависимость от формата сериализованных данных в кодировке base64.
