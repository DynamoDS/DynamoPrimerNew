...
![График прямоугольной сетки](../../.gitbook/assets/cover-image.jpg)
...
![Пакет ZeroTouchLibrary](../../.gitbook/assets/vs-nugetpackage.jpg)

> 1. Найдите пакет ZeroTouchLibrary.
> 2. Этот узел будет использоваться в текущей сборке Dynamo. Выберите версию пакета, соответствующую версии Dynamo.
...
![Сборка DLL](../../.gitbook/assets/vs-grids.jpg)
...
![Подсказка для ввода](../../.gitbook/assets/nodemodification.png)
...
![Прикрепление документации XML](../../.gitbook/assets/vs-xml.jpg)
