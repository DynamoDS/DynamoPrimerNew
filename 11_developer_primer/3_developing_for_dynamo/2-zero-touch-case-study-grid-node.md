...
![직사각형 그리드 그래프](../../.gitbook/assets/cover-image.jpg)
...
![ZeroTouchLibrary 패키지](../../.gitbook/assets/vs-nugetpackage.jpg)

> 1. ZeroTouchLibrary 패키지를 찾아봅니다.
> 2. 이 노드는 현재 사용 중인 Dynamo 빌드에서 사용할 예정입니다. 사용 중인 Dynamo 버전과 일치하는 패키지 버전을 선택합니다.
...
![DLL 빌드하기](../../.gitbook/assets/vs-grids.jpg)
...
![입력 툴팁](../../.gitbook/assets/nodemodification.png)
...
![XML 문서를 사용하도록 설정하기](../../.gitbook/assets/vs-xml.jpg)
