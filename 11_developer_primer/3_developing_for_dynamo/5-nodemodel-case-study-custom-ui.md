...
![График прямоугольной сетки](../../.gitbook/assets/cover-image-2.jpg)
...
![Добавление новой библиотеки классов](../../.gitbook/assets/vs-new-class-projects.jpg)
...
![Обозреватель решений](../../.gitbook/assets/vs-new-class.jpg)
...
![Установка пакетов](../../.gitbook/assets/vs-add-packages.jpg)
...
![Отключение локальной копии пакета](../../.gitbook/assets/vs-disable-package-copying.jpg)
...
![Добавление ссылки](../../.gitbook/assets/vs-add-project-reference.jpg)
...
![Добавление нового ползунка](../../.gitbook/assets/vs-usercontrol.jpg)
...
![Добавление файла JSON](../../.gitbook/assets/vs-pkg-json.jpg)
...
\![Поврежденный файл JSON](<../../.gitbook/assets/broken-json (1).jpg>)
