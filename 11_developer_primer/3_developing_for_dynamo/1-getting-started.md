...
![Visual Studio](<../../.gitbook/assets/visual-studio (1).jpg>)
...
![Création d’un projet dans Visual Studio](<../../.gitbook/assets/vs-new-project-1 (1).jpg>)

![Configuration d’un nouveau projet dans Visual Studio](<../../.gitbook/assets/vs-new-project-2 (1).jpg>)
...
![Utilisation de l’explorateur de solutions](<../../.gitbook/assets/vs-edit-class (1).jpg>)
...
![Paramètres de génération de Visual Studio](<../../.gitbook/assets/vs-build-settings (1).jpg>)
...
![Génération d’une solution](<../../.gitbook/assets/vs-build (1).jpg>)
...
![Structure des fichiers du projet](<../../.gitbook/assets/folder-structure (1).jpg>)
...
![Ouverture du fichier .dll du projet](<../../.gitbook/assets/dyn-import-dll (1).jpg>)
...
![Noeud SampleFunction.MultiplyByTwo dans un graphique](<../../.gitbook/assets/multiplybytwo (1).png>)
...
![Méthode importée en tant que nœud de création](<../../.gitbook/assets/private-constructor (1).jpg>)
...
![Ouverture du gestionnaire de package NuGet](<../../.gitbook/assets/vs-nuget-package-manager2 (1).jpg>)
...
![Gestionnaire de package NuGet](<../../.gitbook/assets/vs-nuget-package-manager (1).jpg>)
...
![Gestionnaire des références](<../../.gitbook/assets/vs-manual-dynamo-package (1).jpg>)
