...
![Usar o Gerenciador de soluções](../../.gitbook/assets/vs-edit-class.jpg)

> 1. Abrir o Gerenciador de soluções e as janelas Saída em `View`.
> 2. Renomear o arquivo `Class1.cs` como `SampleFunction.cs` no Gerenciador de soluções à direita.
...
![Configurações de compilação do Visual Studio](../../.gitbook/assets/vs-build-settings.jpg)
...
![Compilar uma solução](../../.gitbook/assets/vs-build.jpg)
...
![Estrutura de arquivos do projeto](../../.gitbook/assets/folder-structure.jpg)
...
![Abrir o arquivo dll do projeto](../../.gitbook/assets/dyn-import-dll.jpg)
...
> 1. MyCustomNode na biblioteca do Dynamo. A categoria da biblioteca é determinada pelo nome do arquivo `.dll`.
> 2. SampleFunction.MultiplyByTwo na tela.
...
![Nó SampleFunction.MultiplyByTwo em um gráfico](../../.gitbook/assets/multiplybytwo.png)
...
> 3. O nó é nomeado `SampleFunction.MultiplyByTwo`, porque esses são os nomes de classe e método.

No exemplo acima, o nó adicional Criar `SampleFunction` foi criado porque não fornecemos explicitamente um construtor e, portanto, um foi criado automaticamente. Podemos evitar isso criando um construtor privado vazio em nossa classe `SampleFunction`.
...
![Método importado como um nó de criação](../../.gitbook/assets/private-constructor.jpg)
...
![Abrir o gerenciador de pacotes NuGet](../../.gitbook/assets/vs-nuget-package-manager2.jpg)
...
![Gerenciador de pacotes NuGet](../../.gitbook/assets/vs-nuget-package-manager.jpg)
...
> 3. Selecionar a versão do pacote necessária e clicar em instalar. Isso instala um pacote para o projeto específico no qual você está trabalhando. Como estamos usando a versão estável mais recente do Dynamo, escolha a versão do pacote que corresponde à versão do Dynamo com a qual você está trabalhando.
...
![Gerenciador de referências](../../.gitbook/assets/vs-manual-dynamo-package.jpg)
