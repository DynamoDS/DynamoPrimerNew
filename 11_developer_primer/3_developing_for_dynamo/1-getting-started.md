...
![Создание нового проекта в Visual Studio](../../.gitbook/assets/vs-new-project-1.jpg)

![Настройка нового проекта в Visual Studio](../../.gitbook/assets/vs-new-project-2.jpg)
...
![Использование обозревателя решений](../../.gitbook/assets/vs-edit-class.jpg)
...
![Параметры сборки Visual Studio](../../.gitbook/assets/vs-build-settings.jpg)
...
![Сборка решения](../../.gitbook/assets/vs-build.jpg)
...
![Структура файлов проекта](../../.gitbook/assets/folder-structure.jpg)
...
![Открытие DLL-файла проекта](../../.gitbook/assets/dyn-import-dll.jpg)
...
![Пользовательские узлы](../../.gitbook/assets/dyn-customnode.jpg)
...
![Узел SampleFunction.MultiplyByTwo на графике](../../.gitbook/assets/multiplybytwo.png)
...
![Метод импортирован как узел Create](../../.gitbook/assets/private-constructor.jpg)
...
![Открытие диспетчера пакетов NuGet](../../.gitbook/assets/vs-nuget-package-manager2.jpg)
...
![Диспетчер пакетов NuGet](../../.gitbook/assets/vs-nuget-package-manager.jpg)
...
![Диспетчер ссылок](../../.gitbook/assets/vs-manual-dynamo-package.jpg)
