...
> 1. Usando _Math.RemapRange_, remapeie os valores de desvio para um domínio entre 0,15 e 0_,_45 inserindo `0.15; 0.45;` no _Code Block_.
...
\![Exercício](<../.gitbook/assets/07 (4).jpg>)
...
\![Exercício](<../.gitbook/assets/02 (5).jpg>)
