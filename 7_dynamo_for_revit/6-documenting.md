...
![desvio](../.gitbook/assets/deviation.jpg)
...
> 1. Usando _Math.RemapRange_, remapeie os valores de desvio para um domínio entre 0,15 e 0,45 inserindo `0.15; 0.45;` no _Bloco de código_.
...
> 1. Usando _Math.RemapRange_, remapeie os valores de desvio do plano para um intervalo entre _0_ e _1_ (observação: também é possível usar o nó _“MapTo”_ para definir um domínio de origem).
...
> 6. Conecte _Element.SetParameterByName_ à entrada _combinador_ de _List.Combine_. Conecte os _componentes adaptativos_ à _list1_. Conecte a _Sequência de caracteres do objeto_ à _list2_.
