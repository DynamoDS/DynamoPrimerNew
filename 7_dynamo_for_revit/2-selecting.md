...
> 1. 使用_“Element.Faces”_节点，我们得到一个曲面列表，表示 Revit 体量的每个面。现在，我们可以在 Dynamo 视口中看到几何图形，然后开始参照相应面进行参数化操作。
...
> 2. 接着，_“List.Count”_节点显示我们正在处理体量中的 23 个曲面。
> 3. 参照此数字，我们将\*“整数滑块”\*的最大值更改为_“22”_。
> 4. 使用_“List.GetItemAtIndex”_，我们为_“索引”_输入列表和\*“整数滑块”\*。在选定内容之间滑动，直到到达_索引 9_ 并隔离将桁架用作主要外立面时，便停止。
