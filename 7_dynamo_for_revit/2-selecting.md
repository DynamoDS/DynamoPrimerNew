...
> 1. 使用 _“Select Model Element”_ 节点，单击*“select”*（或 _“更改”_ ）按钮。在 Revit 视口中，选择所需的图元。在本例中，我们选择的是建筑体量。
...
假定我们要隔离建筑的主要外立面墙。我们可以使用 _“Select Faces”_ 节点来执行此操作。单击“Select”按钮，然后在 Revit 中选择四个主要外立面。
