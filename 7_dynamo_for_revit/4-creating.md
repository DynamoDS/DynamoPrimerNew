...
> 3. Połącz węzeł _Code Block_ z wejściem _param_ (parametr) węzła _„Curve.PlaneAtParameter”_ i połącz górną krawędź z wejściem _curve_. Uzyskamy w ten sposób dziesięć płaszczyzn równomiernie rozłożonych wzdłuż całej fasady.
