...
> 1. Eseguendo lo zoom indietro e la panoramica a destra nel grafico di esempio, viene visualizzato un gruppo esteso di nodi; si tratta di operazioni geometriche che generano la struttura del tetto a pergolato visibile nell'anteprima di Dynamo. Questi nodi vengono generati utilizzando la funzionalità _Nodo da aggiungere al codice_, come descritto nella [sezione del blocco di codice](../coding-in-dynamo/7_code-blocks-and-design-script/7-2_design-script-syntax.md#Node) della guida introduttiva.
