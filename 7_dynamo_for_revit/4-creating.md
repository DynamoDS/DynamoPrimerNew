...
> 1. 샘플 그래프에서 오른쪽으로 줌을 축소하고 초점이동하면 큰 노드 그룹이 표시됩니다. 이러한 노드 그룹은 Dynamo 미리보기에 표시된 격자 지붕 구조를 생성하는 형상 작업입니다. 이러한 노드는 입문서의 [code block 섹션](../coding-in-dynamo/7_code-blocks-and-design-script/7-2_design-script-syntax.md#Node)에서 설명한 대로 _Node to Code_ 기능을 사용하여 생성됩니다.
