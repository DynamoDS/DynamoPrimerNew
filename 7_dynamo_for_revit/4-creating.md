...
> 1. 缩小并平移到示例图的右侧，我们会看到一组大节点 - 这些是几何操作，可生成在 Dynamo 预览中可见的格子架屋顶结构。这些节点使用_“节点到代码”_功能生成，如 Primer 的[“代码块”部分](../coding-in-dynamo/7_code-blocks-and-design-script/7-2_design-script-syntax.md#Node)中所述。
