...
Per una conversione rapida delle unità, utilizzare il nodo _"Convert Between Units"_. Questo è un comodo strumento per la conversione delle unità di lunghezza, area e volume al volo.
...
> 2. È possibile eseguire una query su tutti i parametri di questa massa con il nodo _"Element.Parameters"_. Ciò include i parametri di tipo e istanza.
