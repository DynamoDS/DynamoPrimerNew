...
| 2020 e versões posteriores         | 2.1.0 — O Revit 2020 e posterior agora inclui o Dynamo e recebe atualizações como o Revit.  | N/D                                                                                                                                     |
...
{% hint style="warning" %}
Observação: O Dynamo será executado somente no arquivo no qual foi aberto.
{% endhint %}
...
{% hint style="info" %}
É possível obter mais informações sobre o congelamento de nós na seção [4_nodes_and_wires](../4_nodes_and_wires/ "menção").
{% endhint %}
