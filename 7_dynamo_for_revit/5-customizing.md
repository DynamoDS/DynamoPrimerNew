...
> 2. Si se activa el camino solar, se puede ver la ubicación actual del sol en Revit.

> 3. Podemos hacer referencia a esta ubicación del sol mediante el nodo _SunSettings.Current_.
