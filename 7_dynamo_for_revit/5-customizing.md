...
> 2. Если включить траекторию солнца, можно увидеть текущее положение солнца в Revit.

> 3. С помощью узла _SunSettings.Current_ можно задать положение солнца в качестве опорного значения.
