...
> 2. Соедините _Code Block_ с портами ввода *u * и _v_ узла _  Surface.PointAtParameter_, а также соедините узел _Surface.ByLoft_ с портом ввода _surface_. Щелкните узел правой кнопкой мыши и задайте для параметра _Переплетение_  значение _Векторное произведение_. На поверхности появится сетка из точек.
