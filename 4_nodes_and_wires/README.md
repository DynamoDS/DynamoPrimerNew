...
{% hint style="info" %}
Dica: Com essa informação de dica de ferramenta disponível, examine os nós a montante para ver se o tipo de dados ou a estrutura de dados requerido está com erro.
{% endhint %}
...
> 3. A montante, o nó de número está armazenando “Vermelho”, e não um número
...
Crie um fio clicando com o botão esquerdo do mouse em uma porta e, em seguida, na porta de outro nó para criar uma conexão. Enquanto estamos no processo de criar uma conexão, o fio aparecerá a tracejado e se tornará uma linha contínua quando for conectado com êxito.
...
Também é possível ocultar somente o fio selecionado clicando com o botão direito do mouse na saída do nó e selecionando Ocultar fios
