...
> 5. Icono de encaje: indica la [opción de encaje](../5_essential_nodes_and_concepts/5-4_designing-with-lists/1-whats-a-list.md#lacing) especificada para las entradas de lista coincidentes (se explicará detalladamente más adelante).
