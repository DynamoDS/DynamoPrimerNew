...
> 5. Lacing Icon - Indicates the [Lacing option](../5_essential_nodes_and_concepts/5-4_designing-with-lists/1-whats-a-list.md#lacing) specified for matching list inputs (more on that later)
...
> 6. Preview off - A gray status bar underneath the node and an eye icon <img src="../.gitbook/assets/nodes and wires - preview off.jpg" alt="" data-size="line"> indicate that geometry preview for the node is switched off.
