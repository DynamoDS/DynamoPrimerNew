...
> 5. Ikona vázání – Označuje [možnost vázání](../5_essential_nodes_and_concepts/5-4_designing-with-lists/1-whats-a-list.md#lacing) zadanou pro odpovídající vstupy seznamu (více informací později).
