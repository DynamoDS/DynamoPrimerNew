...
A parametrização não é particularmente útil ao determinar os pontos usados para gerar curvas, seu principal uso é determinar as localizações dos pontos intermediários gerados pelos construtores NurbsCurve e NurbsSurface.
