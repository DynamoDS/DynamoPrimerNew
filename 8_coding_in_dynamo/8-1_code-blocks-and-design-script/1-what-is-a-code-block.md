...
Code Block 可讓使用者靈活決定如何指定輸入。下面提供了幾種不同方式來使用座標建立基本點 _(10,5,0)_：
...
您可以透過 _Core>Input>Actions>Code Block_ 找到 Code Block。但更快的方式是在圖元區按兩下，Code Block 就會出現。此節點因為經常使用，所以被賦予完整的按兩下權限。
