...
| ---------------------- | -------------------------------------------------------- | ------------------------------------------------------------- |
| Numeri                | \![](<../../.gitbook/assets/01 node - numbers.jpg>)       | \![](<../../.gitbook/assets/01 codeblock - numbers.jpg>)       |
| Stringhe                | \![](<../../.gitbook/assets/02 node - string.jpg>)        | \![](<../../.gitbook/assets/02 codeblock- string.jpg>)         |
| Sequenze              | \![](<../../.gitbook/assets/03 node- sequence.jpg>)       | \![](<../../.gitbook/assets/03 codeblock- sequence.jpg>)       |
| Intervalli                 | \![](<../../.gitbook/assets/04 node- range.jpg>)          | \![](<../../.gitbook/assets/04 codeblock - range.jpg>)         |
| Recupero di una voce nell'indice      | \![](<../../.gitbook/assets/05 node - list get item.jpg>) | \![](<../../.gitbook/assets/05 codeblock - list get item.jpg>) |
| Creazione di un elenco            | \![](<../../.gitbook/assets/06 node - list create.jpg>)   | \![](<../../.gitbook/assets/image (17).png>)                   |
| Concatenazione di stringhe    | \![](<../../.gitbook/assets/07 node - string concat.jpg>) | \![](<../../.gitbook/assets/07 codeblock - string concat.jpg>) |
| Istruzioni condizionali | \![](<../../.gitbook/assets/08 node - conditional.jpg>)   | \![](<../../.gitbook/assets/08 codeblock - conditional.jpg>)   |
...
> 4. Utilizzando il simbolo _"#"_ del passaggio precedente, è ora possibile posizionarlo nella parte _"step-size"_ della sintassi. Ora, è presente un _intervallo di numeri_ che si estende dall'_"inizio"_ alla _"fine"_ e la notazione _"step-size"_ distribuisce uniformemente un numero di valori tra i due: `beginning..end..#ofSteps`.
