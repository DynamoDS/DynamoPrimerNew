...
| ---------------------- | -------------------------------------------------------- | ------------------------------------------------------------- |
| 數字                | [](<../images/01 node - numbers.jpg>)       | [](<../images/01 codeblock - numbers.jpg>)       |
| 字串                | [](<../images/02 node - string.jpg>)        | [](<../images/02 codeblock- string.jpg>)         |
| 序列              | [](<../images/03 node- sequence.jpg>)       | [](<../images/03 codeblock- sequence.jpg>)       |
| 範圍                 | [](<../images/04 node- range.jpg>)          | [](<../images/04 codeblock - range.jpg>)         |
| 取得索引處的項目      | [](<../images/05 node - list get item.jpg>) | [](<../images/05 codeblock - list get item.jpg>) |
| 建立清單            | [](<../images/06 node - list create.jpg>)   | ![](<../images/image.png>)                   |
| 連接字串    | [](<../images/07 node - string concat.jpg>) | [](<../images/07 codeblock - string concat.jpg>) |
| 條件陳述式 | [](<../images/08 node - conditional.jpg>)   | [](<../images/08 codeblock - conditional.jpg>)   |
...
最後，我們使用 Code Block 查詢資料的隔離部分。若要重新產生具有特定範圍點的曲面，請在 **Geometry.Translate** 與 **NurbsSurface.ByPoints** 節點之間加入以上程式碼區塊。這包括文字行：`sineStrips[0..15..1];`。這將選取前 16 列的點 (從 50 個點中)。重新建立曲面，我們可以看到已產生點格線的隔離部分。
