...
| ---------------------- | -------------------------------------------------------- | ------------------------------------------------------------- |
| Chiffres                | ![](<../images/01 node - numbers.jpg>)       | ![](<../images/01 codeblock - numbers.jpg>)       |
| Chaînes                | ![](<../images/02 node - string.jpg>)        | ![](<../images/02 codeblock- string.jpg>)         |
| Séquences              | ![](<../images/03 node- sequence.jpg>)       | ![](<../images/03 codeblock- sequence.jpg>)       |
| Intervalles                 | ![](<../images/04 node- range.jpg>)          | ![](<../images/04 codeblock - range.jpg>)         |
| Obtenir l’élément au niveau de l’index      | ![](<../images/05 node - list get item.jpg>) | ![](<../images/05 codeblock - list get item.jpg>) |
| Création d’une liste            | ![](<../images/06 node - list create.jpg>)   | ![](<../images/image.png>)                   |
| Concaténer des chaînes    | ![](<../images/07 node - string concat.jpg>) | ![](<../images/07 codeblock - string concat.jpg>) |
| Instructions conditionnelles | ![](<../images/08 node - conditional.jpg>)   | ![](<../images/08 codeblock - conditional.jpg>)   |
