...
> 3. _Sequence_ 의 예는 최대 15개의 리스트가 아니라, 리스트에 포함된 15개의 값을 원한다는 사실을 나타내기 위해 "#"을 사용한다는 점을 제외하고 비슷합니다. 여기서는 `beginning..#ofSteps..step-size:`를 정의합니다. 시퀀스의 실제 구문은 `0..#15..2`입니다.
> 4. 이번에는 이전 단계의 _"#"_ 을 구문의 _"step-size"_ 부분에 배치합니다. 이제 _숫자 범위_는 _"beginning"_ 부터 _"end"_ 까지 걸쳐 있으며, _"step-size"_ 표기법은 여러 개의 값을 둘 사이에 균일하게 분산합니다(`beginning..end..#ofSteps`).
...
>
> 3\. 세 번째 **Code Block**은 **List.Transpose**, **List.Count** 및 **Number Range** 노드를 대치합니다.
>
