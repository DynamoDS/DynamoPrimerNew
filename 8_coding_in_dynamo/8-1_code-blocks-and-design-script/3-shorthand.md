...
> 4. 이번에는 이전 단계의 _"#"_ 을 구문의 _"step-size"_ 부분에 배치합니다. 이제 _숫자 범위_ 는 _"beginning"_ 부터 _"end"_ 까지 걸쳐 있으며, _"step-size"_ 표기법은 여러 개의 값을 둘 사이에 균일하게 분산합니다(`beginning..end..#ofSteps`).
