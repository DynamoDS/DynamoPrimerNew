...
New syntax for list@level, to use `list@L1` instead of `list@-1` ![](../images/lang2_1.png)
...
If the user dropped the first node on the canvas and connected a list of geometries, he will expect replication to kick in but it would never happen because at runtime the second overload will be called instead as shown: ![](../images/lang2_2.png)
...
**Associative update is disabled in CBN’s by preventing variable redefinition:** ![](../images/lang2_17.png)
...
**The corresponding ZT node return value is marshaled as a Dynamo Dictionary:** ![](../images/lang2_22.png)

**2. Multi-return nodes are previewed as Dictionaries**

**Zero Touch node returning IDictionary with Multi-Return Attribute returns a Dynamo Dictionary:** ![](../images/lang2_23.png)
