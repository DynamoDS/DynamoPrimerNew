...
Nouvelle syntaxe pour list@level, afin d’utiliser `list@L1` au lieu de `list@-1` ![](<../../.gitbook/assets/lang2_1 (1).png>)
...
**A. La fonction représentée par le nœud de l’interface utilisateur n’était pas toujours la même que celle utilisée au moment de l’exécution.**
...
**B. Le deuxième problème était que les méthodes d’instance ne fonctionnaient pas avec des tableaux hétérogènes.**
...
**Lisible :** les résultats correspondent aux attentes des utilisateurs et sont plus faciles à appréhender
...
**La mise à jour associative est désactivée dans les CBN en empêchant la redéfinition des variables :** ![](<../../.gitbook/assets/lang2_17 (1).png>)
...
**Consider the following zero-touch C# method returning an IDictionary:** ![](<../../.gitbook/assets/lang2_21 (1).png>)

**La valeur de retour correspondante du nœud ZT est convertie en dictionnaire Dynamo :** ![](<../../.gitbook/assets/lang2_22 (1).png>)

**2. Les nœuds à retours multiples sont prévisualisés en tant que dictionnaires**

**Le nœud Zero-Touch renvoyant IDictionary avec l’attribut Multi-Return renvoie un dictionnaire Dynamo :** ![](<../../.gitbook/assets/lang2_23 (1).png>)

![](<../../.gitbook/assets/lang2_24 (1).png>)
...
**ZT method with an IDictionary parameter:** ![](<../../.gitbook/assets/lang2_25 (1).png>)

**ZT node accepts Dynamo Dictionary as input:** ![](<../../.gitbook/assets/lang2_26 (1).png>)
...
Notez également que les aperçus des blocs de code ne sont pas ordonnés, contrairement au nœud d’interface utilisateur, car les informations du port de sortie (sous la forme d’un attribut MultiReturn) n’existent pas pour le nœud Code Block : ![](<../../.gitbook/assets/lang2_27 (1).png>)
