...
**A. Funkcja reprezentowana przez węzeł interfejsu użytkownika nie zawsze była tą samą funkcją, która była wykonywana w czasie wykonywania**
...
**B. Drugim problemem było to, że metody wystąpienia nie działały z szykami (tablicami) heterogenicznymi**
