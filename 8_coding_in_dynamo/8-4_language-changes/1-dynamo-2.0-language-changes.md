...
Новый синтаксис для list@level: требуется `list@L1` вместо `list@-1` ![](../images/lang2_1.png).
...
Если пользователь перетащит первый узел в активное окно и подключит список геометрий, он будет ожидать, что сработает репликация, но этого не произойдет, потому что во время выполнения вместо нее будет вызвана вторая перегрузка, как показано на следующем изображении: ![](../images/lang2_2.png)
...
**Ассоциативное обновление отключено в CBN путем запрета на переопределение переменной:** ![](../images/lang2_17.png)
...
**Рассмотрим следующий метод C# Zero Touch, возвращающий IDictionary:** ![](../images/lang2_21.png)

**Возвращаемое значение соответствующего узла Zero Touch преобразуется в словарь Dynamo:** ![](../images/lang2_22.png)

**2\. Узлы, возвращающие несколько значений, предварительно отображаются в виде словарей**

**Узел Zero Touch, возвращающий параметр IDictionary с атрибутом нескольких возвращаемых значений, возвращает словарь Dynamo:** ![](../images/lang2_23.png)

![](../images/lang2_24.png)

**3\. Словарь Dynamo можно передать в качестве входных данных в узел Zero Touch, принимающий словарь .NET**

**Метод Zero Touch с параметром IDictionary:** ![](../images/lang2_25.png)

**Узел Zero Touch принимает словарь Dynamo в качестве входных данных:** ![](../images/lang2_26.png)
...
В отличие от узла пользовательского интерфейса, предварительный просмотр для блоков кода не упорядочен, так как сведения о выходных портах (в виде атрибута с несколькими возвращаемыми значениями) не существуют для узла Code Block: ![](../images/lang2_27.png)
