...
> 1. Para añadir entradas adicionales al nodo, haga clic en el icono + del nodo. Las entradas se denominan IN\[0], IN\[1], etc. para indicar que representan elementos de una lista.
