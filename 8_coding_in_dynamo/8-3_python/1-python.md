...
> 1. **Inputs.** Измените имена входных параметров, сделав их более описательными, и добавьте типы данных и значения по умолчанию.
