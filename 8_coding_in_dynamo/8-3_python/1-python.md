...
![](<../../.gitbook/assets/python node - the python node 01 (1).jpg>)
...
![](<../../.gitbook/assets/python node - the python node 02 (1).jpg>)

La bibliothèque Autodesk.DesignScript.Geometry vous permet d’utiliser la notation par points de manière similaire aux blocs de code. Pour plus d’informations sur la syntaxe de Dynamo, reportez-vous à la rubrique [https://github.com/DynamoDS/DynamoPrimerNew/blob/master-fra/coding-in-dynamo/7\_code-blocks-and-design-script/7-2\_design-script-syntax.md](https://github.com/DynamoDS/DynamoPrimerNew/blob/master-fra/coding-in-dynamo/7_code-blocks-and-design-script/7-2_design-script-syntax.md "mention") et au document [Guide de DesignScript](https://dynamobim.org/wp-content/links/DesignScriptGuide.pdf) (pour télécharger ce document PDF, cliquez avec le bouton droit de la souris sur le lien et choisissez « Enregistrer le lien sous… »). Si vous tapez un type de géométrie tel que « Point », une liste de méthodes permettant de créer et d’interroger des points s’affiche.

![](<../../.gitbook/assets/python node - the python node 03 (1).jpg>)
...
{% file src="../../.gitbook/assets/Python_Custom-Node (1).dyn" %}
...
![](<../../.gitbook/assets/python node - exercise pt I-01 (1).jpg>)
...
![](<../../.gitbook/assets/python node - exercise pt I-02 (1).jpg>)
...
![](<../../.gitbook/assets/python node - exercise pt I-03 (1).jpg>)
...
![](<../../.gitbook/assets/python node - exercise pt I-04 (1).jpg>)
...
![](<../../.gitbook/assets/python node - exercise pt I-05 (1).jpg>)
...
![](<../../.gitbook/assets/python node - exercise pt I-06 (1).jpg>)
...
![](<../../.gitbook/assets/python node - exercise pt I-07 (1).jpg>)
...
![](<../../.gitbook/assets/python node - exercise pt II-01 (1).jpg>)

Attribuez un nom, une description et une catégorie.

![](<../../.gitbook/assets/python node - exercise pt II-02 (1).jpg>)

Un nouvel espace de travail s’ouvre dans lequel vous pouvez modifier le nœud personnalisé.

![](<../../.gitbook/assets/python node - exercise pt II-03 (1).jpg>)
...
![](<../../.gitbook/assets/python node - exercise pt II-04 (1).jpg>)
