...
Программа Dynamo доступна в качестве расширения в Forma. На данный момент решение поставляется в двух вариантах: классическая версия для настольных компьютеров и облачная интеграция в виде закрытой бета-версии. Подробнее о классической версии читайте в этой [публикации блога](https://dynamobim.org/dynamo-in-forma/), а о бета-интеграции в облаке — в этой [публикации блога](https://dynamobim.org/dynamo-as-a-service-powers-up-dynamo-player-in-forma/). Обратите внимание, что статья была опубликована на этапе закрытой бета-версии; интеграция в облаке в настоящее время представлена в открытой бета-версии и доступна всем пользователям Forma.
