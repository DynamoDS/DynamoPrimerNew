...
* ![](<images/user-interface-open.png>) Ouvrir : permet d’ouvrir un fichier .dyn (espace de travail) ou .dyf (nœud personnalisé) existant
* ![](<images/user-interface-save.png>) Enregistrer/Enregistrer sous : permet d’enregistrer votre fichier .dyn ou .dyf actif
* ![](<images/user-interface-undo.jpg>) Annuler : permet d’annuler la dernière action
* ![](<images/user-interface-redo.jpg>) Rétablir : permet de rétablir la prochaine action
* ![](<images/user-interface-screenshot.png>) Exporter l’espace de travail en tant qu’image : permet d’exporter l’espace de travail visible en tant que fichier PNG.
