...
* ![](<images/user-interface-open.png>) Otwórz — otwórz istniejący plik .dyn (obszar roboczy) lub .dyf (węzeł niestandardowy)
* ![](<images/user-interface-save.png>) Zapisz/Zapisz jako — zapisz aktywny plik .dyn lub .dyf
...
* ![](<images/user-interface-screenshot.png>) Eksportuj obszar roboczy jako obraz — eksportuj widoczny obszar roboczy jako plik PNG
