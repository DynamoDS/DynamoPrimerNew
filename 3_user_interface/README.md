...
Confira aqui os menus para a funcionalidade básica do aplicativo Dynamo. Como a maioria dos softwares para Windows, os dois primeiros menus estão relacionados ao gerenciamento de arquivos, às operações de seleção e à edição de conteúdo. Os menus restantes são mais específicos do Dynamo.
...
* ![](../.gitbook/assets/user-interface-new-file.jpg) Novo — Cria um novo arquivo .dyn
* ![](../.gitbook/assets/user-interface-open.png) Abrir — Abre um arquivo .dyn (espaço de trabalho) ou .dyf (nó personalizado) existente
* ![](../.gitbook/assets/user-interface-save.png) Salvar/Salvar como — Salva o arquivo .dyn ou .dyf ativo
* ![](../.gitbook/assets/user-interface-undo.jpg) Desfazer — Desfaz a última ação
* ![](../.gitbook/assets/user-interface-redo.jpg) Refazer — Refaz a próxima ação
* ![](../.gitbook/assets/user-interface-screenshot.png) Exportar espaço de trabalho como imagem — Exporta o espaço de trabalho visível como um arquivo PNG
