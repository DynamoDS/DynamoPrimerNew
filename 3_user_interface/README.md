...
* \![](<../.gitbook/assets/user interface - new file.jpg>) Создать: создать файл DYN.
* \![](<../.gitbook/assets/user interface - open (1).jpg>) Открыть: открыть существующий файл DYN (рабочее пространство) или DYF (пользовательский узел).
* \![](<../.gitbook/assets/user interface - save.jpg>) Сохранить/Сохранить как: сохранить активный файл DYN или DYF.
...
* \![](<../.gitbook/assets/user interface - screenshot.jpg>) Экспорт рабочего пространства в виде изображения: экспорт видимого рабочего пространства в файл PNG.
