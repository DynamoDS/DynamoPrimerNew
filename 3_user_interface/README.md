...
* ![](<images/user-interface-new-file.jpg>) Novo – Criar um novo arquivo .dyn
* ![](<images/user-interface-open.png>) Abrir – Abre um arquivo .dyn (espaço de trabalho) ou .dyf (nó personalizado) existente
* ![](<images/user-interface-save.png>) Salvar/Salvar como – Salvar o arquivo .dyn ou .dyf ativo
* ![](<images/user-interface-undo.jpg>) Desfazer – Desfaz a última ação
* ![](<images/user-interface-redo.jpg>) Refazer – Refaz a próxima ação
* ![](<images/user-interface-screenshot.png>) Exportar espaço de trabalho como imagem – Exporta o espaço de trabalho visível como um arquivo PNG
