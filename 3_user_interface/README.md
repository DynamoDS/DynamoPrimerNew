...
* \![](<../.gitbook/assets/user interface - new file.jpg>) 新建 - 创建一个新的 .dyn 文件
* \![](<../.gitbook/assets/user interface - open (1).png>) 打开 - 打开现有的 .dyn（工作空间）或 .dyf（自定义节点）文件
* \![](<../.gitbook/assets/user interface - save.png>) 保存/另存为 - 保存活动的 .dyn 或 .dyf 文件
* \![](<../.gitbook/assets/user interface - undo.jpg>) 撤消 - 撤消上一个操作
* \![](<../.gitbook/assets/user interface - redo.jpg>) 重做 - 重做下一个操作
* \![](<../.gitbook/assets/user interface - screenshot.png>) 将工作空间输出为图像 - 将可见工作空间输出为 PNG 文件
