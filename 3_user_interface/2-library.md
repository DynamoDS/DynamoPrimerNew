...
* \![](<../.gitbook/assets/user interface - create.jpg>) **创建**：从头开始创建或构建几何图形。例如，圆。
* \![](<../.gitbook/assets/user interface - action.jpg>) **操作**：对对象执行操作。例如，缩放圆。
...
| 节点           |                                                        | 节点           |                                                        |
| -------------- | ------------------------------------------------------ | -------------- | ------------------------------------------------------ |
| 布尔        | \![](<../.gitbook/assets/library - boolean.jpg>)        | 编号         | \![](<../.gitbook/assets/library - number.jpg>)         |
| 字符串         | \![](<../.gitbook/assets/library - string.jpg>)         | Number Slider  | \![](<../.gitbook/assets/library - number slider.jpg>)  |
| Directory Path | \![](<../.gitbook/assets/library - directory path.jpg>) | Integer Slider | \![](<../.gitbook/assets/library - integer slider.jpg>) |
| 文件路径      | \![](<../.gitbook/assets/library - file path.jpg>)      |                |                                                        |
