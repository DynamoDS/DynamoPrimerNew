...
* ![](images/3-2/userinterface-create.jpg) **Crea**: consente di creare o costruire la geometria da zero. Ad esempio, un cerchio.
* ![](images/3-2/userinterface-action.jpg) **Azione**: consente di eseguire un'azione su un elemento. Ad esempio, la messa in scala di un cerchio.
* ![](images/3-2/userinterface-query.jpg) **Query**: consente di ottenere una proprietà di un oggetto già esistente. Ad esempio, ottenere il raggio di un cerchio.
