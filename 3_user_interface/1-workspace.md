...
* \![](<../.gitbook/assets/2.3-04 Graph preview icon.jpg>)Visualização de gráfico
* \![](<../.gitbook/assets/2.3-05 3D preview icon.jpg>)Visualização 3D

b. Clique com o botão direito do mouse no espaço de trabalho

* Alterne Visualização 3D para Visualização de gráfico

\![](<../.gitbook/assets/workspace - right click switch to graph view.jpg>)

* Alterne Visualização de gráfico para Visualização 3D
...
* Com ícones:
  * \![](<../.gitbook/assets/2.3-08 graph preview zoom to fitpsd.jpg>)Zoom para ajustar
  * \![](<../.gitbook/assets/2.3-09 graph preview zoom in.jpg>)Aproximar zoom
  * \![](<../.gitbook/assets/2.3-10 graph preview zoom out.jpg>)Afastar zoom
