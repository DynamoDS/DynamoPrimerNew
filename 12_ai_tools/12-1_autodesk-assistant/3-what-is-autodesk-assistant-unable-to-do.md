...
Autodesk Assistant for Dynamo is not able to directly alter the Revit document or model. Revit has its own version of Autodesk Assistant that makes changes to the Revit model and document, the Assistant for Dynamo will notify the user that it is unable to directly alter the Revit document.
