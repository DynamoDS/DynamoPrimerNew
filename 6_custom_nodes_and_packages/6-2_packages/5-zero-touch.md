...
| **Logo/obraz** | **Nazwa** |
| ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| ![](<../images/6-2/5/meshToolkit case study 01.jpg>) | [Zestaw narzędzi Mesh Toolkit](https://github.com/DynamoDS/Dynamo/wiki/Dynamo-Mesh-Toolkit) |
| ![](<../images/6-2/5/package introduction - installing package folder 07.jpg>) | [Witryna Dynamo Unfold](http://dynamobim.com/dynamounfold/) |
...
W tej analizie przypadku pokazano, jak zaimportować [AForge](http://www.aforgenet.com) — zewnętrzną bibliotekę _.dll_. AForge to rozbudowana biblioteka, która zapewnia szeroką gamę funkcji, od przetwarzania obrazu po sztuczną inteligencję. Na potrzeby poniższych ćwiczeń dotyczących przetwarzania obrazu skorzystamy z klasy Imaging w bibliotece AForge.
...
W dodatku Dynamo utwórz nowy plik i wybierz kolejno opcje _Plik > Importuj bibliotekę_
...
> 1. W wyskakującym okienku przejdź do folderu Release w instalacji biblioteki AForge. Prawdopodobnie będzie on się znajdował w folderze podobnym do tego: _C:\Program Files (x86)\AForge.NET\Framework\Release_.
...
W obszarze AForge.Imaging.AForge.Imaging.Filters (w menu nawigacji) można zauważyć, że dostępna jest szeroka gama filtrów. Użyjemy teraz jednego z tych filtrów, aby zdesaturować obraz na podstawie wartości progowych.
