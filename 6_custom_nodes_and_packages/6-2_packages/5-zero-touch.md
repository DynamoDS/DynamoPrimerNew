...
後續步驟將提供熟練使用 [AForge Imaging API](http://www.aforgenet.com/framework/docs/html/d087503e-77da-dc47-0e33-788275035a90.htm) 的某些技巧。您不需要瞭解 Dynamo 工作的所有這些技巧。這比較是示範在 Dynamo 環境中靈活使用外部資源庫。
