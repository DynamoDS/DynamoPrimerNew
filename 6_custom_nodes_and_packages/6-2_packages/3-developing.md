...
한 표면에서 다른 표면으로의 점 UV 매핑을 보여 주는 샘플 패키지로 작업해 보겠습니다. 이 입문서의 [사용자 지정 노드 작성](../6-1_custom-nodes/2-creating.md) 섹션에서 이미 도구의 기본 기능을 구축했습니다. 아래의 파일은 UV 매핑의 개념을 파악하고 게시 가능한 라이브러리를 위한 도구 세트를 개발하는 방법을 보여 줍니다.
