...
<figure><img src="../../.gitbook/assets/map-to-surface-install (1).png" alt=""><figcaption></figcaption></figure>

Une fois l’installation terminée, les nœuds personnalisés sont disponibles sous la section Compléments > DynamoPrimer.

![](<../../.gitbook/assets/publish a package - publish locally 04 (2).jpg>)
...
![](<../../.gitbook/assets/develop package -pointToSurface (1).jpg>)
...
![](<../../.gitbook/assets/develop package -polygonsToSurface (1).jpg>)
...
![](<../../.gitbook/assets/develop package -nurbsCrvtoSurface (1).jpg>)
...
![](<../../.gitbook/assets/develop package -OffsetPointsToSurface (1).jpg>)
...
![](<../../.gitbook/assets/develop package -sampleSrf (1).jpg>)
...
![](<../../.gitbook/assets/develop package -sample file 01 (1).jpg>)
...
![](<../../.gitbook/assets/develop package -sample file 02 (1).jpg>)
...
![](<../../.gitbook/assets/develop package -sample file 03 (1).jpg>)
...
![](<../../.gitbook/assets/develop package -sample file 04a (1).jpg>)

Polysurface source mappée entre la surface source et la surface cible.

![](<../../.gitbook/assets/develop package -sample file 04b (1).jpg>)
...
![](<../../.gitbook/assets/develop package -sample file 05c (1).jpg>)
