...
В строке меню Dynamo выберите _Пакеты > Поиск пакета..._. В поле поиска введите _MeshToolkit_ одним словом (без пробелов) и с соблюдением регистра. Нажмите кнопку «Установить», чтобы начать скачивание. Проще простого.
