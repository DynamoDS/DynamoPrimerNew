...
{% hint style="info" %}
Confira a seção [2-library.md](../3_user_interface/2-library.md "menção") para obter mais informações sobre como os nós da biblioteca principal do Dynamo são organizados.
{% endhint %}
