...
<figure><img src="../../images/Utilities_RenameStructures_SelectStructures.png" alt=""><figcaption><p>Выбор колодцев на заданном слое</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_GetPosition.png" alt=""><figcaption><p>Использование ограничивающих рамок для получения приближенной точки вставки каждого колодца</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_FilterAndSort.png" alt=""><figcaption><p>Фильтрация и сортировка колодцев</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_GenerateNames.png" alt=""><figcaption><p>Создание новых имен колодцев</p></figcaption></figure>

### Переименование колодцев

Наконец, мы может переименовать колодцы.

<figure><img src="../../images/Utilities_RenameStructures_SetName.png" alt="" width="289"><figcaption><p>Задание имен колодцев</p></figcaption></figure>

### Результат

Ниже приведен пример запуска графика с помощью **проигрывателя Dynamo**.

<figure><img src="../../images/Utilities_RenameStructures_Player.gif" alt=""><figcaption><p>Запуск графика с помощью проигрывателя Dynamo и просмотр результатов в Civil 3D</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_Visualize.png" alt=""><figcaption><p>Визуализация геометрии колодцев и характерных линий коридора</p></figcaption></figure>

Теперь мы можем наглядно увидеть, как работает процесс фильтрации колодцев по смещениям.

<figure><img src="../../images/Utilities_RenameStructures_Dynamo.gif" alt=""><figcaption><p>Корректировка порогового значения смещения трассы и визуализация соответствующих колодцев в Dynamo</p></figcaption></figure>
