...
<figure><img src="../../images/Utilities_RenameStructures_SelectStructures.png" alt=""><figcaption><p>選取給定圖層上的結構</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_GetPosition.png" alt=""><figcaption><p>使用邊界框取得每個結構的近似插入點</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_FilterAndSort.png" alt=""><figcaption><p>篩選和排序結構</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_GenerateNames.png" alt=""><figcaption><p>產生新的結構名稱</p></figcaption></figure>

### 更名結構

最後也是同樣重要的，我們更名結構。

<figure><img src="../../images/Utilities_RenameStructures_SetName.png" alt="" width="289"><figcaption><p>設定結構的名稱</p></figcaption></figure>

### 結果

以下是使用 **Dynamo 播放器**執行圖表的範例。

<figure><img src="../../images/Utilities_RenameStructures_Player.gif" alt=""><figcaption><p>使用 Dynamo 播放器執行圖表，然後在 Civil 3D 中查看結果</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_Visualize.png" alt=""><figcaption><p>視覺化結構和廊道地勢線的幾何圖形</p></figcaption></figure>

現在，我們可以更清楚瞭解透過偏移篩選結構的流程如何運作。

<figure><img src="../../images/Utilities_RenameStructures_Dynamo.gif" alt=""><figcaption><p>調整定線偏移門檻值，然後在 Dynamo 中視覺化受影響的結構</p></figcaption></figure>
