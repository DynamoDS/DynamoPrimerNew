...
<figure><img src="../../images/Utilities_RenameStructures_SelectStructures.png" alt=""><figcaption><p>选择给定图层上的结构</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_GetPosition.png" alt=""><figcaption><p>使用边界框获取每个结构的近似插入点</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_FilterAndSort.png" alt=""><figcaption><p>过滤和排序结构</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_GenerateNames.png" alt=""><figcaption><p>生成新的结构名称</p></figcaption></figure>

### 重命名结构

最后但同样重要的是，我们重命名结构。

<figure><img src="../../images/Utilities_RenameStructures_SetName.png" alt="" width="289"><figcaption><p>设置结构的名称</p></figcaption></figure>

### 结果

以下是一个使用 **Dynamo 播放器**运行图形的示例。

<figure><img src="../../images/Utilities_RenameStructures_Player.gif" alt=""><figcaption><p>使用 Dynamo 播放器运行图形并在 Civil 3D 中查看结果</p></figcaption></figure>
...
<figure><img src="../../images/Utilities_RenameStructures_Visualize.png" alt=""><figcaption><p>可视化结构和道路要素线的几何图形</p></figcaption></figure>

现在，我们可以更好地了解按偏移过滤结构的过程是如何工作的。

<figure><img src="../../images/Utilities_RenameStructures_Dynamo.gif" alt=""><figcaption><p>调整“路线偏移”阈值，并在 Dynamo 中可视化受影响的结构</p></figcaption></figure>
