...
{% hint style="info" %}
Agrupe os pontos por outras **categorias predefinidas** que você escolher (por exemplo, “Pontos de terreno”, “Monumentos” etc.)
{% endhint %}

{% hint style="info" %}
Crie automaticamente superfícies TIN para pontos em determinados grupos.
{% endhint %}
