...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_GetExcelData (2).png" alt="" width="548"><figcaption><p>Importação de dados do Excel para o Dynamo</p></figcaption></figure>
...
{% hint style="info" %}
Se os dicionários forem algo novo para você, veja a seção [5-5_dictionaries-in-dynamo](../../../5_essential_nodes_and_concepts/5-5_dictionaries-in-dynamo/ "menção").
{% endhint %}
...
{% hint style="info" %}
Se os blocos de código forem algo novo para você, veja a seção [8-1_code-blocks-and-design-script](../../../8_coding_in_dynamo/8-1_code-blocks-and-design-script/ "menção").
{% endhint %}
...
{% hint style="info" %}
Você pode ler mais sobre os modos de execução de gráficos na seção [3_user_interface](../../../3_user_interface/ "menção").
{% endhint %}
