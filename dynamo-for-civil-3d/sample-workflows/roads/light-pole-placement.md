...
{% hint style="info" %}\r\n Jeśli pierwszy raz masz do czynienia ze słownikami, skorzystaj z sekcji [5-5_dictionaries-in-dynamo](../../../5\_essential\_nodes\_and\_concepts/5-5\_dictionaries-in-dynamo/ "mention"). \r\n{% endhint %}
...
{% hint style="info" %}\r\n Jeśli pierwszy raz masz do czynienia z węzłami Code Block, skorzystaj z sekcji [8-1_code-blocks-and-design-script](../../../8\_coding\_in\_dynamo/8-1\_code-blocks-and-design-script/ "mention"). \r\n{% endhint %}
...
{% hint style="info" %}\r\n Więcej informacji na temat trybów wykonywania wykresów można znaleźć w sekcji [3_user_interface](../../../3\_user\_interface/ "mention"). \r\n{% endhint %}
