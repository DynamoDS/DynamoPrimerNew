...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_Player.gif" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_ExcelFile (1).png" alt=""><figcaption><p>Structure du tableau du fichier Excel</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_GetExcelData.png" alt="" width="548"><figcaption><p>Importation des données Excel dans Dynamo</p></figcaption></figure>
...
{% hint style="info" %}
Si vous ne connaissez pas les dictionnaires, consultez la section \[5-5\_dictionaries-in-dynamo]\(../../../5\\\_essential\\\_nodes\\\_and\\\_concepts/5-5\\\_dictionaries-in-dynamo/ "mention").
{% endhint %}

<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_Dictionary (1).png" alt=""><figcaption><p>Insertion des données Excel dans un dictionnaire</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_DictionaryRetrieval (1).png" alt=""><figcaption><p>Récupération des données du dictionnaire</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_GetCorridorFeatureLines (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_GetCoordinateSystems.png" alt=""><figcaption><p>Obtention de systèmes de coordonnées le long des lignes caractéristiques du terrain du projet 3D</p></figcaption></figure>
...
{% hint style="info" %}
Si vous ne connaissez pas les blocs de code, consultez la section \[8-1\_code-blocks-and-design-script]\(../../../8\\\_coding\\\_in\\\_dynamo/8-1\\\_code-blocks-and-design-script/ "mention").
{% endhint %}
...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_GetBlockDefinitions (1).png" alt=""><figcaption><p>Obtention des définitions de bloc souhaitées à partir du document</p></figcaption></figure>

La dernière étape consiste à créer les références de bloc.

<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_CreateBlockReferences (1).png" alt=""><figcaption><p>Création de références de bloc dans l’espace objet</p></figcaption></figure>
...
{% hint style="info" %}
Pour en savoir plus sur les modes d’exécution des graphiques, consultez la section \[3\_user\_interface]\(../../../3\\\_user\\\_interface/ "mention").
{% endhint %}

<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_Excel (1).gif" alt=""><figcaption><p>Mise à jour du fichier Excel et visualisation rapide des résultats dans Civil 3D</p></figcaption></figure>

Voici un exemple d’exécution du graphique à l’aide du **Lecteur Dynamo**.

<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_Player.gif" alt=""><figcaption><p>Exécution du graphique à l’aide du Lecteur Dynamo et visualisation des résultats dans Civil 3D</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_VisualizeCorridor.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Roads_CorridorBlockRefs_Dynamo (1).png" alt=""><figcaption><p>Visualisation de la géométrie du projet 3D dans Dynamo</p></figcaption></figure>
