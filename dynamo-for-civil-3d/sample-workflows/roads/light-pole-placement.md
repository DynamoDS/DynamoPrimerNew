...
{% hint style="info" %}
如果您对使用词典不熟悉，请参见 [5-5_Dynamo 中的词典](../../../5\_essential\_nodes\_and\_concepts/5-5\_dictionaries-in-dynamo/ "提及")部分。
{% endhint %}
...
{% hint style="info" %}
如果您对使用代码块不熟悉，请参见 [8-1_代码块和 DesignScript](../../../8\_coding\_in\_dynamo/8-1\_code-blocks-and-design-script/ "提及")部分。
{% endhint %}
...
{% hint style="info" %}
可以在 [3_用户界面](../../../3\_user\_interface/ "提及")部分中，了解有关图形执行模式的详细信息。
{% endhint %}
