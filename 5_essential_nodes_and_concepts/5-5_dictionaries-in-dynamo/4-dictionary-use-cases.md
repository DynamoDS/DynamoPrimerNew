...
> 2. 现在，我们可以按房间所在的标高对房间进行分组。

![](../images/5-5/4/dictionary-exerciseII-03.jpg)

> 3. 按标高对图元进行分组后，我们现在可以使用共享键（唯一键）作为词典的键，以及将房间列表作为元素。

![](../images/5-5/4/dictionary-exerciseII-04.jpg)

> 4. 最后，使用 Revit 模型中的标高，我们可以在词典中查找位于该标高的房间。`Dictionary.ValueAtKey` 将获取标高名称并返回该标高处的房间对象。
