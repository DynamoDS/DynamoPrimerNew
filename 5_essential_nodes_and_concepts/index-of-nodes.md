...
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
|                                            | CREATE                                                                                                                |                                                                   |
| ![](<images/5-1/ColorbyARGB (1).jpg>)      | <p><strong>Color.ByARGB</strong><br>Construct a color by alpha, red, green, and blue components.</p>                  | ![](<images/5-1/indexofnodes-colorbyargb(1) (1) (2).jpg>)         |
...
|                                            | ACTIONS                                                                                                               |                                                                   |
| ![](<images/5-1/ColorBrightness (1).jpg>)  | <p><strong>Color.Brightness</strong><br>Gets the brightness value for this color.</p>                                 | ![](<images/5-1/indexofnodes-colorbrightness(1) (1) (1) (1).jpg>) |
...
| ![](<images/5-1/ColorSaturation (1).jpg>)  | <p><strong>Color.Saturation</strong><br>Gets the saturation value for this color</p>                                  | ![](images/5-1/indexofnodes-colorsaturation.jpg)                  |
| ![](<images/5-1/ColorHue (1) (1).jpg>)     | <p><strong>Color.Hue</strong><br>Gets the hue value for this color.</p>                                               | ![](images/5-1/indexofnodes-colorhue.jpg)                         |
|                                            | QUERY                                                                                                                 |                                                                   |
...
| ![](<images/5-1/ColorBlue (1).jpg>)        | <p><strong>Color.Blue</strong><br>Find the blue component of a color, 0 to 255.</p>                                   | ![](images/5-1/indexofnodes-colorblue.jpg)                        |
...
| ![](<images/5-1/ColorRed (1).jpg>)         | <p><strong>Color.Red</strong><br>Find the red component of a color, 0 to 255.</p>                                     | ![](images/5-1/indexofnodes-colorred.jpg)                         |

|                                                           |                                                                                           |                                                               |
| --------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
|                                                           | CREATE                                                                                    |                                                               |
| ![](<images/5-1/GeometryColorByGeometryColor(1) (1).jpg>) | <p><strong>GeometryColor.ByGeometryColor</strong><br>Displays geometry using a color.</p> | ![](images/5-1/indexofnodes-geometrycolorbygeometrycolor.jpg) |
...
| ![](<images/5-1/number(1) (1) (1) (1).jpg>) | <p><strong>Number</strong><br>Creates a number.</p>                                                      | ![](<images/5-1/indexofnodes-number(1) (1) (1).jpg>) |
...
| ![](<images/5-1/Count(1) (1) (1) (1).jpg>) | <p><strong>List.Count</strong><br>Returns the number of items stored in the given list.</p>                                                                                                                                                   | ![](<images/5-1/indexofnodes-count(1)(1) (1) (2) (3).jpg>) |
...
| ![](<images/5-1/Map(1) (1) (1).jpg>)     | <p><strong>Map</strong><br>Maps a value into an input range</p>                                                              | ![](images/5-1/indexofnodes-mathmap.jpg)              |
...
| ![](images/5-1/Stringjoin.jpg)     | <p><strong>String.Join</strong><br>Concatenates multiple strings into a single string, inserting the given separator between each joined string.</p> | ![](<images/5-1/indexofnodes-stringjoin(1) (1).jpg>) |
...
| -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
|                                                                      | CREATE                                                                                                                                     |                                                                  |
| ![](<images/5-1/Cuboidbylength(1) (1) (2).jpg>)                      | <p><strong>Cuboid.ByLengths</strong><br>Create a Cuboid centered at WCS origin, with width, length, and height.</p>                        | ![](images/5-1/indexofnodes-cuboidbylengths.jpg)                 |
| ![](<images/5-1/Cuboidbylengthorigin(1) (1) (1).jpg>)                | <p><strong>Cuboid.ByLengths</strong> (origin)</p><p>Create a Cuboid centered at input Point, with specified width, length, and height.</p> | ![](images/5-1/indexofnodes-cuboidbylengthsorigin.jpg)           |
| ![](<images/5-1/Cuboidbylengthcoordinatessystem(1) (1) (1) (1).jpg>) | <p><strong>Cuboid.ByLengths</strong> (coordinateSystem)</p><p>Create a Cuboid centered at WCS origin, with width, length, and height.</p>  | ![](images/5-1/indexofnodes-cuboidbylengthscoordinatesystem.jpg) |
...
| ![](<images/5-1/Cuboidlength(1) (1).jpg>)                            | <p><strong>Cuboid.Length</strong></p><p>Return the input dimensions of the Cuboid, NOT the actual world space dimensions. **</p>           | ![](images/5-1/indexofnodes-cuboidlength.jpg)                    |
...
| -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
|                                                          | CREATE                                                                                                                                               |                                                              |
| ![](<images/5-1/Surfacebyloft(1)(1) (1) (1).jpg>)        | <p><strong>Surface.ByLoft</strong><br>Create a Surface by lofting between input cross section Curves</p>                                             | ![](images/5-1/indexofnodes-surfacebyloft.jpg)               |
| ![](<images/5-1/Surfacebyloft(1)(1) (1) (1) (1).jpg>)    | <p><strong>Surface.ByPatch</strong><br>Create a Surface by filling in the interior of a closed boundary defined by input Curves.</p>                 | ![](<images/5-1/indexofnodes-surfacebypatch(1) (1) (1).jpg>) |
|                                                          | ACTIONS                                                                                                                                              |                                                              |
| ![](<images/5-1/Surfaceoffset(1) (1).jpg>)               | <p><strong>Surface.Offset</strong><br>Offset Surface in direction of Surface normal by specified distance</p>                                        | ![](images/5-1/indexofnodes-surfaceoffset.jpg)               |
...
| ![](<images/5-1/Surfacethicken(1) (1) (1) (1).jpg>)      | <p><strong>Surface.Thicken</strong><br>Thicken Surface into a Solid, extruding in the direction of Surface normals on both sides of the Surface.</p> | ![](images/5-1/indexofnodes-surfacethicken.jpg)              |
...
| ------------------------------------------------ | ------------------------------------------------------------------------- | ------------------------------------------------ |
|                                                  | CREATE                                                                    |                                                  |
| ![](<images/5-1/UVbycoordinates(1) (1) (1).jpg>) | <p><strong>UV.ByCoordinates</strong><br>Create a UV from two doubles.</p> | ![](images/5-1/indexofnodes-UVbycoordinates.jpg) |
...
| ![](<images/5-1/Vectorxaxis(1) (1) (1).jpg>)     | <p><strong>Vector.XAxis</strong><br>Gets the canonical X axis Vector (1,0,0)</p>         | ![](images/5-1/indexofnodes-vectorx.jpg)             |
| ![](<images/5-1/Vectoryaxis(1) (1) (1).jpg>)     | <p><strong>Vector.YAxis</strong><br>Gets the canonical Y axis Vector (0,1,0)</p>         | ![](images/5-1/indexofnodes-vectory.jpg)             |
...
| ![](<images/5-1/Division(1)(1) (1) (1).jpg>)   | <p><strong>/</strong><br>Division</p>                                                                                   | ![](images/5-1/indexofnodes-division.jpg)       |
