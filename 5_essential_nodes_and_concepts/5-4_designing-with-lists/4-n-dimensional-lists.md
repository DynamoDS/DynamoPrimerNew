...
![Lalki](../images/145493363_fc9ff5164f_o.jpg)
...
\![Ćwiczenie](<../images/n-dimensional lists - 2d lists basic 01.jpg>)
...
>
> 2\. W węźle **Surface.PointAtParameter** połącz te dwie wartości z węzła Code Block z elementami u i _v_. Zmień opcję _skratowania_ tego węzła na _„Iloczyn wektorowy”_.
>
...
> 1. Ponieważ hierarchia ma jeszcze jeden poziom, należy użyć węzła **List.Map** z funkcją **List.Transpose**, aby zmienić kierunek krzywych NURBS.
