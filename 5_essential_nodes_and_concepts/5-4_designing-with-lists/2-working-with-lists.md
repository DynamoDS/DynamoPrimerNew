...
![cartes](<../../.gitbook/assets/Playing_cards_modified (1).jpg>)
...
![](<../../.gitbook/assets/working with list - list operation (1).jpg>)
...
![Nombre](<../../.gitbook/assets/working with list - list operation - list count (1).jpg>)
...
{% file src="../../.gitbook/assets/List-GetItemAtIndex (1).dyn" %}

**List.GetItemAtIndex** est une méthode fondamentale pour interroger un élément de la liste.

![Exercice](<../../.gitbook/assets/working with list - get item index 01 (1).jpg>)
...
![](<../../.gitbook/assets/working with list - get item index 02 (1).gif>)
...
![Exercice](<../../.gitbook/assets/working with list - list reverse (1).jpg>)
...
![Exercice](<../../.gitbook/assets/working with list - shiftIndices 01 (1).jpg>)
...
![](<../../.gitbook/assets/working with list - shiftIndices 02 (1).jpg>)
...
{% file src="../../.gitbook/assets/List-FilterByBooleanMask (1).dyn" %}

![](<../../.gitbook/assets/ListFilterBool (1).png>)
...
![Exercice](<../../.gitbook/assets/working with list - filter by bool mask (1).jpg>)
