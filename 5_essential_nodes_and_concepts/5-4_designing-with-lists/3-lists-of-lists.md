...
_참고: 이 연습은 이전 버전의 Dynamo로 작성되었습니다. _ **List.Map** _기능의 대부분은_ **List@Level** _기능을 추가하여 해결되었습니다. 자세한 내용은 _아래의 _ [_List@Level_](3-lists-of-lists.md#lists-of-lists)을 참조하십시오._
