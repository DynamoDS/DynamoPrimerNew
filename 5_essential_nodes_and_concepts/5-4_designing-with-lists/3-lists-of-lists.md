...
![Pièces de monnaie](<../../.gitbook/assets/coins-521245_640 (1).jpg>)
...
{% file src="../../.gitbook/assets/Top-Down-Hierarchy (1).dyn" %}
...
![de haut en bas](<../../.gitbook/assets/lists of lists - top down hierachy (1).jpg>)
...
{% file src="../../.gitbook/assets/Flatten (1).dyn" %}
...
![Exercice](<../../.gitbook/assets/lists of lists - flatten 01 (1).jpg>)
...
![Exercice](<../../.gitbook/assets/lists of lists - flatten 02 (1).jpg>)
...
{% file src="../../.gitbook/assets/Chop (1).dyn" %}
...
![Exercice](<../../.gitbook/assets/lists of lists - chop (1).jpg>)
...
{% file src="../../.gitbook/assets/Map (1).dyn" %}
...
![](<../../.gitbook/assets/lists of lists - map 01 (1).jpg>)
...
![Exercice](<../../.gitbook/assets/lists of lists - map 03 (1).jpg>)
...
_Remarque : cet exercice a été créé avec une version précédente de Dynamo. La plupart des fonctionnalités List.Combine ont été résolues avec l’ajout de la fonction_ **List@Level**. \_ Pour plus d’informations, reportez-vous à la rubrique\_ [_List@Level_](https://github.com/DynamoDS/DynamoPrimerNew/blob/master-fra/5_essential_nodes_and_concepts/5-4_designing-with-lists/6-3_lists-of-lists.md#listlevel) _ci-dessous._
...
![Exercice](<../../.gitbook/assets/lists of lists - combined 01 (1).jpg>)
...
![Exercice](<../../.gitbook/assets/lists of lists - combined 02 (1).jpg>)
...
{% file src="../../.gitbook/assets/Listatlevel (1).dyn" %}
...
![List@Level](<../../.gitbook/assets/lists of lists - list at level 01 (1).jpg>)
...
![List@Level](<../../.gitbook/assets/lists of lists - list at level 02 (1).jpg>)
...
![](<../../.gitbook/assets/lists of lists - list at level 03 (1).jpg>)
...
![](<../../.gitbook/assets/lists of lists - list at level 04 (1).jpg>)
...
![Transposer](<../../.gitbook/assets/transpose1 (1).jpg>)
...
![](<../../.gitbook/assets/lists of lists - transpose 01 (1).jpg>)
...
![](<../../.gitbook/assets/lists of lists - transpose 02 (1).jpg>)
...
![](<../../.gitbook/assets/lists of lists - codeblock for list creation 01 (1).jpg>)
...
![](<../../.gitbook/assets/lists of lists - codeblock for list creation 02 (1).jpg>)
...
![](<../../.gitbook/assets/list of lists - exercise cb insert & query 01 (1).jpg>)
...
![](<../../.gitbook/assets/list of lists - exercise cb insert & query 02 (1).jpg>)
...
![](<../../.gitbook/assets/list of lists - exercise cb insert & query 03 (1).jpg>)
...
![](<../../.gitbook/assets/list of lists - exercise cb insert & query 04 (1).jpg>)
...
![](<../../.gitbook/assets/list of lists - exercise cb insert & query 05 (1).jpg>)
...
![](<../../.gitbook/assets/list of lists - exercise cb insert & query 06 (1).jpg>)

> 1. Créez un nœud **NurbsCurve.ByPoints** et connectez la nouvelle structure de données pour créer trois courbes NURBS.

![](<../../.gitbook/assets/list of lists - exercise cb insert & query 07 (1).jpg>)
