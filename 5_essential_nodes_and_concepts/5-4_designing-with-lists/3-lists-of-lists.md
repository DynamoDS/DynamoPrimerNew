...
> 1. 在 **Code Bock** 中插入一行程式碼以定義範圍：`-250..-150..#4;`
...
{% hint style="info" %}
請參閱 n 維清單中的練習，以查看使用 List.Combine 的另一個範例。{% endhint %}
...
> 2. 使用 **List.ReplaceItemAtIndex**，我們將運用索引 _「2」_，將中間項目更換為連接至移動點的更換項目 (**Geometry.Translate**)。
