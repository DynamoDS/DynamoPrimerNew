...
\![メッシュ ツールキット](<../../.gitbook/assets/meshes - mesh toolkit standford bunny.jpg>)
...
![メッシュの要素](../../.gitbook/assets/MeshElements2.jpg)

> 1. メッシュの頂点
> 2. メッシュの辺 
>    1. 隣接する面が 1 つだけの辺を「裸の辺」と呼びます。それ以外のすべての辺を、「おおわれた辺」と呼びます。
> 3. メッシュの面
...
![頂点と法線](../../.gitbook/assets/vertexNormals.jpg)
...
![コントロール ポイント](../../.gitbook/assets/NURBSvsMESH-01.jpg)
...
![編集](../../.gitbook/assets/NURBSvsMESH-02.jpg)
