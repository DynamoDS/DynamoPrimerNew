...
\![Набор инструментов для работы с сеткой](<../images/meshes - mesh toolkit standford bunny.jpg>)
...
![Элементы сети](../images/MeshElements2.jpg)

> 1. Вершины сети
> 2. Ребра сети 
>    1. Ребра, у которых только одна прилегающая грань, называются открытыми, все остальные ребра являются закрытыми.
> 3. Грани сети
...
![Вершины + нормали](../images/vertexNormals.jpg)
...
![Управляющие точки](../images/NURBSvsMESH-01.jpg)
...
![Редактирование](../images/NURBSvsMESH-02.jpg)
