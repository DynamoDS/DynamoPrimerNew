...
{% file src="../../.gitbook/assets/Geometry for Computational Design - Solids (1).dyn" %}
...
![](<../../.gitbook/assets/solids - freeze node (1).jpg>)
...
{% hint style="info" %}
Pour en savoir plus sur le gel des nœuds, consultez la section \[4\_nodes\_and\_wires]\(../../4\_nodes\_and\_wires/ "mention").
{% endhint %}
...
![Solides](<../../.gitbook/assets/Primitives (1).jpg>)
...
![Topologie](<../../.gitbook/assets/Solid-topology (1).jpg>)
...
![](<../../.gitbook/assets/SolidOperations (1).jpg>)
...
Cela rend les objets booléens solides extrêmement efficaces. Il existe trois opérations booléennes de solide qui permettent de distinguer les parties de la géométrie qui sont conservées. ![Opération booléenne de solide](<../../.gitbook/assets/SolidBooleans (1).jpg>)
...
Outre ces trois opérations, Dynamo dispose des nœuds **Solid.DifferenceAll** et **Solid.UnionAll** pour effectuer des opérations de différence et d’union avec plusieurs solides. ![](<../../.gitbook/assets/BooleanAll (1).jpg>)
