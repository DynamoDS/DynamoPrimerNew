...
![](<../../.gitbook/assets/points - 3d point in dynamo (1).jpg>)

Un point 2D dans Dynamo possède deux coordonnées \[X, Y].

![](<../../.gitbook/assets/points - 2d point in dynamo (1).jpg>)
...
![](<../../.gitbook/assets/points - xyz vs coord sys vs uv (1).jpg>)
...
{% file src="../../.gitbook/assets/Geometry for Computational Design - Points (1).dyn" %}
...
![Point à courbe](<../../.gitbook/assets/PointsAsBuildingBlocks-1 (1).jpg>)
...
![Points en tant que coordonnées](<../../.gitbook/assets/Coordinates (1).jpg>)
