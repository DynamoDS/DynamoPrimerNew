...
![](<../../.gitbook/assets/geometry overview - geometry in dynamo (1).jpg>)
...
![](<../../.gitbook/assets/Geometry for Computational Design - Overview (1).jpg>)
...
{% file src="../../.gitbook/assets/Geometry for Computational Design - Geometry Overview (1).dyn" %}
...
![Le lapin de Stanford](<../../.gitbook/assets/StanfordBunny (1).jpg>)
...
![Géometrie de calcul](<../../.gitbook/assets/Geometry for - GeometryDimensionality.jpg>)
...
![Hiérarchie de la géométrie](<../../.gitbook/assets/GeometryHierarchy (1).jpg>)
