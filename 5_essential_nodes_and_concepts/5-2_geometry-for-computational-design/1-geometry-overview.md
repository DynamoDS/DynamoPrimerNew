...
\![Geometria computacional](<../../.gitbook/assets/Geometry for - GeometryDimensionality.jpg>)

> 1. Um **Ponto** (definido por coordenadas) não possui cotas, apenas números que descrevem cada coordenada
