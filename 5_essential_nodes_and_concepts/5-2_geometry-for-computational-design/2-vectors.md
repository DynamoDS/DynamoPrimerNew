...
![Vecteurs dans Dynamo](<../../.gitbook/assets/Geometry for Computational Design  - vectors (1).jpg>)
...
![Plans dans Dynamo](<../../.gitbook/assets/Geometry for Computational Design  - plane (1).jpg>)
...
![Système de coordonnées dans Dynamo](<../../.gitbook/assets/Geometry for Computational Design - Coordinate (1).jpg>)
...
{% file src="../../.gitbook/assets/Geometry for Computational Design - Coordinate System (1).dyn" %}
...
![Vecteurs, plans et coordonnées](<../../.gitbook/assets/VectorsPlanesCoodinates (1).jpg>)
...
![Détails du vecteur](<../../.gitbook/assets/Vector-Detailed (1).jpg>)
...
![Vecteur](<../../.gitbook/assets/Vector (1).jpg>)
...
![Plan](<../../.gitbook/assets/Plane (1).jpg>)
...
![Système de coordonnées](<../../.gitbook/assets/CoordinateSystem (1).jpg>)
