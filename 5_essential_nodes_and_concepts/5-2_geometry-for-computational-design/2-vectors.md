...
[Vetor](2-vectors.md#vector-1) é uma representação de magnitude e direção. É possível visualizá-lo como uma seta que acelera em uma determinada direção a uma velocidade especificada. É um componente-chave para os nossos modelos no Dynamo. Observe que, como eles estão na categoria Abstrata de “Auxiliares”, quando criamos um vetor, não veremos nada na Visualização do plano de fundo.

\![Vetores no Dynamo](<../../.gitbook/assets/Geometry for Computational Design - vectors.jpg>)
...
\![Planos no Dynamo](<../../.gitbook/assets/Geometry for Computational Design - plane.jpg>)
...
\![Sistema de coordenadas no Dynamo](<../../.gitbook/assets/Geometry for Computational Design - Coordinate.jpg>)
...
![Vetores, planos e coordenadas](../../.gitbook/assets/VectorsPlanesCoodinates.jpg)
...
![Detalhes do vetor](../../.gitbook/assets/Vector-Detailed.jpg)
...
![Vetor](../../.gitbook/assets/Vector.jpg)
...
![Plano](../../.gitbook/assets/Plane.jpg)
...
E você está correto! A maioria dos softwares de modelagem aproveita os planos de construção ou “níveis” para definir um contexto bidimensional local no qual desenhar. XY, XZ, YZ ou Norte, Sudeste, Plano pode parecer mais familiar. Todos esses são os Planos, definindo um contexto "plano" infinito. Os planos não têm profundidade, mas eles também nos ajudam a descrever a direção.
...
![Sistema de coordenadas](../../.gitbook/assets/CoordinateSystem.jpg)
