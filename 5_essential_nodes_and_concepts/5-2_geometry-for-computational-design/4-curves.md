...
![Tipos de curvas](../../.gitbook/assets/CurveTypes.jpg)
...
A [linha](4-curves.md#lines) é composta por um conjunto de pontos e cada linha tem ao menos dois pontos. Um dos modos mais comuns de criar linhas no Dynamo é usando `Line.ByStartPointEndPoint` ![](images/5-2/4/Linebystartpointendpoint.jpg) para criar uma linha no Dynamo.
...
![Parâmetro de curva](../../.gitbook/assets/CurveParameter.jpg)
...
![Polilinha + Polígono](../../.gitbook/assets/Polyline.jpg)
...
![Arcos + Círculos](../../.gitbook/assets/Arcs+Circles.jpg)
...
![Grau da curva NURBS](../../.gitbook/assets/NURBScurve_Degree.jpg)
