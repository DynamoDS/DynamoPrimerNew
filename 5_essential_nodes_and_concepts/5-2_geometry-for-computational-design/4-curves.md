...
![Tipos de curvas](../images/CurveTypes.jpg)
...
A [linha](4-curves.md#lines) é composta por um conjunto de pontos e cada linha tem ao menos dois pontos. Um dos modos mais comuns de criar linhas no Dynamo é usando [](4-curves.md#lines) ``Line.ByStartPointEndPoint` para criar uma linha no Dynamo.
...
![Parâmetro de curva](../images/CurveParameter.jpg)
...
![Polilinha + Polígono](../images/Polyline.jpg)
...
![Arcos + Círculos](../images/Arcs+Circles.jpg)
...
![Curva NURBS](../images/NURBScurve.jpg)
...
![Grau da curva NURBS](../images/NURBScurve_Degree.jpg)
