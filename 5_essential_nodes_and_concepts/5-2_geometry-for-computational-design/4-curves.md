...
![Типы кривых](../images/CurveTypes.jpg)
...
[Отрезок](4-curves.md#lines) состоит из набора точек. В каждом отрезке должно быть не менее 2 точек. Один из наиболее распространенных способов создания отрезка в Dynamo — использование  ``Line.ByStartPointEndPoint` для создания отрезка в Dynamo.
...
![Параметр кривой](../images/CurveParameter.jpg)
...
![Полилиния + полигон](../images/Polyline.jpg)
...
![Дуги + окружности](../images/Arcs+Circles.jpg)
...
![NURBS-кривая](../images/NURBScurve.jpg)
...
![Степень NURBS-кривой](../images/NURBScurve_Degree.jpg)
