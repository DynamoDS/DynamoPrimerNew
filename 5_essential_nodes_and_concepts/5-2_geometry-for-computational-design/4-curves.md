...
[Line ](4-curves.md#lines)is made of a set of points, each line has at least 2 points. One of the most common way to create line in Dynamo is using `Line.ByStartPointEndPoint` ![](../../.gitbook/assets/Linebystartpointendpoint.jpg) to create a Line in Dynamo.

![](<../../.gitbook/assets/curves - line by start point end point (1).jpg>)
...
![NURBS Curve Degree](../../.gitbook/assets/NURBScurve_Degree.jpg)
