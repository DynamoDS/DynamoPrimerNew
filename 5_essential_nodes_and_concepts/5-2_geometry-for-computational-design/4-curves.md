...
La [ligne](4-curves.md#lines) est un ensemble de points. Chaque ligne contient au moins 2 points. L’une des méthodes les plus courantes pour créer une ligne dans Dynamo consiste à utiliser\`\`Line.ByStartPointEndPoint\`.
...
![](<../../.gitbook/assets/curves - Nurbs Curves (1).jpg>)
...
{% file src="../../.gitbook/assets/Geometry for Computational Design - Curves (1).dyn" %}
...
![Paramètre de courbe](<../../.gitbook/assets/CurveParameter (1).jpg>)
...
![Ligne](<../../.gitbook/assets/Line (1).jpg>)
...
![Polyligne + polygone](<../../.gitbook/assets/Polyline (1).jpg>)
...
![Arcs + cercles](<../../.gitbook/assets/Arcs+Circles (1).jpg>)
...
![Courbe NURBS](<../../.gitbook/assets/NURBScurve (1).jpg>)
...
![Degré des courbes NURBS](<../../.gitbook/assets/NURBScurve_Degree (1).jpg>)
