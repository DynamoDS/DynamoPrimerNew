...
[곡선](4-curves.md#deep-dive-into...)은 우리가 다룬 첫 번째 기하학적 데이터 유형으로, 선이 얼마나 굽었는지, 얼마나 직선에 가까운지, 얼마나 길거나 짧은지 등 형태를 설명하는 보다 익숙한 속성을 가집니다. 또한 점이 선에서 스플라인 사이의 모든 항목과 그 사이의 모든 곡선 유형을 정의하기 위한 빌딩 블록이라는 점은 그대로입니다.

![곡선 유형](../../.gitbook/assets/CurveTypes.jpg)
...
[선](4-curves.md#lines)은 여러 점으로 이루어지며 각 선에는 최소 2개의 점이 있습니다. Dynamo에서 선을 작성하는 가장 일반적인 방법 중 하나는 `Line.ByStartPointEndPoint` ![](images/5-2/4/Linebystartpointendpoint.jpg)를 사용하여 Dynamo에서 선을 작성하는 것입니다.
...
![곡선 매개변수](../../.gitbook/assets/CurveParameter.jpg)
...
![폴리선 + 다각형](../../.gitbook/assets/Polyline.jpg)
...
![호 + 원](../../.gitbook/assets/Arcs+Circles.jpg)
...
![NURBS 곡선](../../.gitbook/assets/NURBScurve.jpg)
...
![NURBS 곡선 차수](../../.gitbook/assets/NURBScurve_Degree.jpg)
