...
1\. Adicionar **Point.ByCoordinates** – após adicionarmos o nó à tela, vemos um ponto na origem da grade de visualização do Dynamo. Os valores padrão das entradas _x,y_ e _z_ são _0,0_, especificando um ponto nessa localização.
