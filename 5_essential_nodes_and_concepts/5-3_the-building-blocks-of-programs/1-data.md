...
\![Dados e ações](<../../.gitbook/assets/data - what is data.jpg>)
...
\![Detalhamento da lista](<../../.gitbook/assets/data - data structures.jpg>)

> 1. Um nó **Number Sequence** define uma lista de números usando as entradas _início_, _quantidade_ e _etapa_. Com esses nós, criamos duas listas separadas de dez números, uma que vai de _100 a 109_ e outra que vai de _0 a 9_.
...
1\. Adicionar **Point.ByCoordinates** – após adicionarmos o nó à tela, vemos um ponto na origem do eixo de visualização do Dynamo. Os valores padrão das entradas _x,y_ e _z_ são _0,0_, especificando um ponto nesse local.
...
10\. Esta etapa é mais complicada, portanto, vamos explicá-la devagar: o objetivo final é criar uma lista de números que definem as localizações de cada cilindro em uma linha.
...
12\. A cadeia de cilindros ainda está dinamicamente vinculada a todos os controles deslizantes. Flexibilize cada controle deslizante para observar a atualização da definição.
