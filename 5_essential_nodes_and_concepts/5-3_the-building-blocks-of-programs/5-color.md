...
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| \![](<../../.gitbook/assets/Color byARGB.jpg>) | Colore ARGB (**Color.ByARGB**) | A,R,G,B | colore   |
...
| Icona                                             | Nome (Sintassi)                     | Input | Output    |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Alpha.jpg>)     | Alfa (**Color.Alpha**)           | colore  | A          |
| \![](<../../.gitbook/assets/Color Red.jpg>)       | Rosso (**Color.Red**)               | colore  | R          |
| \![](<../../.gitbook/assets/Color Green.jpg>)     | Verde (**Color.Green**)           | colore  | G          |
| \![](<../../.gitbook/assets/Color Blue.jpg>)      | Blu (**Color.Blue**)             | colore  | B          |
| \![](<../../.gitbook/assets/Color Component.jpg>) | Componenti (**Color.Components**) | colore  | A,R,G,B |
...
| Icona                                                  | Nome (Sintassi)                     | Input | Output    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Hue.jpg>)            | Tonalità (**Color.Hue**)               | colore  | Tonalità        |
| \![](<../../.gitbook/assets/Color Saturation (1).jpg>) | Saturazione (**Color.Saturation**) | colore  | Saturazione |
| \![](<../../.gitbook/assets/Color Brightness.jpg>)     | Luminosità (**Color.Brightness**) | colore  | Luminosità |
