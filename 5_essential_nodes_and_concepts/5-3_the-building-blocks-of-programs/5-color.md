...
| 아이콘                                          | 이름(구문)                 | 입력  | 출력 |
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| \![](<../../.gitbook/assets/Color byARGB.jpg>) | ARGB 색상(**Color.ByARGB**) | A,R,G,B | 색상   |
...
| 아이콘                                             | 이름(구문)                     | 입력 | 출력    |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Alpha.jpg>)     | 알파(**Color.Alpha**)           | 색상  | A          |
| \![](<../../.gitbook/assets/Color Red.jpg>)       | 빨간색(**Color.Red**)               | 색상  | R          |
| \![](<../../.gitbook/assets/Color Green.jpg>)     | 초록색(**Color.Green**)           | 색상  | G          |
| \![](<../../.gitbook/assets/Color Blue.jpg>)      | 파란색(**Color.Blue**)             | 색상  | B          |
| \![](<../../.gitbook/assets/Color Component.jpg>) | 구성요소(**Color.Components**) | 색상  | A,R,G,B |
...
| 아이콘                                                  | 이름(구문)                     | 입력 | 출력    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Hue.jpg>)            | 색조(**Color.Hue**)               | 색상  | 색조        |
| \![](<../../.gitbook/assets/Color Saturation (1).jpg>) | 채도(**Color.Saturation**) | 색상  | 채도 |
| \![](<../../.gitbook/assets/Color Brightness.jpg>)     | 밝기(**Color.Brightness**) | 색상  | 밝기 |
...
> 1. 세 가지 색상 정의: **Code Block** 노드를 사용하여 적절한 _0_ 및 _255_ 조합을 연결함으로써 _빨간색, 초록색_ 및 _파란색_ 을 정의합니다.
...
다음 단계는 나선형 점부터 참조점까지의 거리 리스트로 매개변수를 구동하는 것입니다. 이러한 거리 값을 사용하여 곡선을 따라 일련의 구 반지름을 정의합니다. 구형이 적절한 크기로 유지되도록 하려면 거리 값을 _다시 매핑_ 해야 합니다.
