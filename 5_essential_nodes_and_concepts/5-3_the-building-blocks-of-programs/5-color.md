...
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| \![](<../../.gitbook/assets/Color byARGB.jpg>) | Couleur ARVB (**Color.ByARGB**) | A,R,G,B | color   |
...
| \![](<../../.gitbook/assets/Color Red.jpg>)       | Rouge (**Color.Red**)               | color  | R          |
| \![](<../../.gitbook/assets/Color Green.jpg>)     | Vert (**Color.Green**)           | color  | G          |
| \![](<../../.gitbook/assets/Color Blue.jpg>)      | Bleu (**Color.Blue**)             | color  | B          |
| \![](<../../.gitbook/assets/Color Component.jpg>) | Composants (**Color.Components**) | color  | A,R,G,B |
...
| Icône                                                  | Nom (Syntaxe)                     | Entrées | Sorties    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Hue.jpg>)            | Teinte (**Color.Hue**)               | color  | Teinte        |
| \![](<../../.gitbook/assets/Color Saturation (1).jpg>) | Saturation (**Color.Saturation**) | color  | Saturation |
| \![](<../../.gitbook/assets/Color Brightness.jpg>)     | Luminosité (**Color.Brightness**) | color  | Luminosité |
