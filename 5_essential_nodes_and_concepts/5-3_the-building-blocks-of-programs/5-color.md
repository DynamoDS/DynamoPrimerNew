...
| ------------------------------------------------- | ----------------------------- | ------- | ------- |
| ![](<../../.gitbook/assets/Color byARGB (2).jpg>) | ARGB Color (**Color.ByARGB**) | A,R,G,B | color   |
...
| ![](<../../.gitbook/assets/Color Red (1).jpg>)       | Red (**Color.Red**)               | color  | R          |
| ![](<../../.gitbook/assets/Color Green (1).jpg>)     | Green (**Color.Green**)           | color  | G          |
| ![](<../../.gitbook/assets/Color Blue (2).jpg>)      | Blue (**Color.Blue**)             | color  | B          |
| ![](<../../.gitbook/assets/Color Component (1).jpg>) | Components (**Color.Components**) | color  | A, R, G, B |
...
| Icon                                                  | Name (Syntax)                     | Inputs | Outputs    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| ![](<../../.gitbook/assets/Color Hue (1).jpg>)        | Hue (**Color.Hue**)               | color  | Hue        |
| ![](<../../.gitbook/assets/Color Saturation (2).jpg>) | Saturation (**Color.Saturation**) | color  | Saturation |
| ![](<../../.gitbook/assets/Color Brightness (2).jpg>) | Brightness (**Color.Brightness**) | color  | Brightness |
