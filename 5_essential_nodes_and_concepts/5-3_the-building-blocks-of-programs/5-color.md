...
| アイコン                                             | 名前(構文)                     | 入力 | 出力    |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Alpha.jpg>)     | アルファ(**Color.Alpha**)           | color  | A          |
| \![](<../../.gitbook/assets/Color Red.jpg>)       | 赤(**Color.Red**)               | color  | R          |
| \![](<../../.gitbook/assets/Color Green.jpg>)     | 緑(**Color.Green**)           | color  | G          |
| \![](<../../.gitbook/assets/Color Blue.jpg>)      | 青(**Color.Blue**)             | color  | B          |
| \![](<../../.gitbook/assets/Color Component.jpg>) | コンポーネント(**Color.Components**) | color  | A、R、G、B |
...
| アイコン                                                  | 名前(構文)                     | 入力 | 出力    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Hue.jpg>)            | 色相(**Color.Hue**)               | color  | Hue        |
| \![](<../../.gitbook/assets/Color Saturation (1).jpg>) | 彩度(**Color.Saturation**) | color  | 飽和率 |
| \![](<../../.gitbook/assets/Color Brightness.jpg>)     | 明るさ(**Color.Brightness**) | color  | Brightness |
