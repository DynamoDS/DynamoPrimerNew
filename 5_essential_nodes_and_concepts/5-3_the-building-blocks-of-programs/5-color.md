...
| ---------------------------------------- | ----------------------------- | ------- | ------- |
| ![](<../images/5-1/ColorbyARGB (2).jpg>) | Цвет ARGB (**Color.ByARGB**) | A,R,G,B | color   |
...
| Значок                                              | Имя (синтаксис)                     | Входные данные | Выходные данные    |
| ------------------------------------------------- | --------------------------------- | ------ | ---------- |
| ![](<../images/5-1/ColorAlpha(1)(1) (2) (2).jpg>) | Альфа (**Color.Alpha**)           | color  | A          |
| ![](../images/5-1/ColorRed.jpg)                   | Красный (**Color.Red**)               | color  | R          |
| ![](<../images/5-1/ColorGreen(1)(1) (2) (1).jpg>) | Зеленый (**Color.Green**)           | color  | G          |
| ![](../images/5-1/ColorBlue.jpg)                  | Синий (**Color.Blue**)             | color  | B          |
| ![](<../images/5-1/ColorComponent (2).jpg>)       | Компоненты (**Color.Components**) | color  | A, R, G, B |
...
| Значок                                         | Имя (синтаксис)                     | Входные данные | Выходные данные    |
| -------------------------------------------- | --------------------------------- | ------ | ---------- |
| ![](../images/5-1/ColorHue.jpg)              | Оттенок (**Color.Hue**)               | color  | Hue        |
| ![](<../images/5-1/ColorSaturation (2).jpg>) | Насыщенность (**Color.Saturation**) | color  | Saturation |
| ![](<../images/5-1/ColorBrightness (2).jpg>) | Яркость (**Color.Brightness**) | color  | Brightness |
