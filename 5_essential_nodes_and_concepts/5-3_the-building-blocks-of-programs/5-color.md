...
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| ![](<../images/5-3/5/Color byARGB.jpg>) | Kolor ARGB (**Colour.ByARGB**) | A, R, G, B | color |
...
| Ikona | Nazwa (składnia) | Dane wejściowe | Wyjścia |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| ![](<../images/5-3/5/Color Alpha.jpg>) | Alfa (**Colour.Alpha**) | color | A |
...
> 1. **Węzeł Geometry.DistanceTo:** połącz element wyjściowy węzła **Curve.PointAtParameter** z _elementem wejściowym_. Połącz węzeł **Point.ByCoordinates** z wejściem geometry.
...
> 1. **Węzeł Color Range:** dodaj do obszaru rysunku. Po najechaniu kursorem na element wejściowy _value_ zobaczymy, że wymagane są liczby z zakresu od 0 do 1. Należy ponownie odwzorować liczby wyjściowe z węzła **Geometry.DistanceTo**, aby były zgodne z tą dziedziną.
