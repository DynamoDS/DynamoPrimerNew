...
> 1. **Geometry.DistanceTo:** **Curve.PointAtParameter** 출력을 _입력_ 에 연결합니다. **Point.ByCoordinates**를 형상 입력에 연결합니다.
...
> 2. **Code Block:** _0_ 과 _255_ 의 두 값을 작성합니다. 위 이미지에 따라 두 출력을 두 **Color.ByARGB** 입력에 연결합니다(또는 선호하는 두 가지 색상 작성).
