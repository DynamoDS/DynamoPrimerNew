...
| アイコン                                             | 名前(構文)                     | 入力 | 出力    |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| ![](<../images/Color Alpha.jpg>)     | アルファ(**Color.Alpha**)           | color  | A          |
| ![](<../images/Color Red.jpg>)       | 赤(**Color.Red**)               | color  | R          |
| ![](<../images/Color Green.jpg>)     | 緑(**Color.Green**)           | color  | G          |
| ![](<../images/Color Blue.jpg>)      | 青(**Color.Blue**)             | color  | B          |
| ![](<../images/Color Component.jpg>) | コンポーネント(**Color.Components**) | color  | A、R、G、B |
...
| アイコン                                                  | 名前(構文)                     | 入力 | 出力    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| ![](<../images/Color Hue.jpg>)            | 色相(**Color.Hue**)               | color  | Hue        |
| ![](<../images/Color Saturation.jpg>) | 彩度(**Color.Saturation**) | color  | 飽和率 |
| ![](<../images/Color Brightness.jpg>)     | 明るさ(**Color.Brightness**) | color  | Brightness |
