...
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| \![](<../../.gitbook/assets/Color byARGB.jpg>) | Цвет ARGB (**Color.ByARGB**) | A,R,G,B | color   |
...
| Значок                                             | Имя (синтаксис)                     | Входные данные | Выходные данные    |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Alpha.jpg>)     | Альфа (**Color.Alpha**)           | color  | A          |
| \![](<../../.gitbook/assets/Color Red.jpg>)       | Красный (**Color.Red**)               | color  | R          |
| \![](<../../.gitbook/assets/Color Green.jpg>)     | Зеленый (**Color.Green**)           | color  | G          |
| \![](<../../.gitbook/assets/Color Blue.jpg>)      | Синий (**Color.Blue**)             | color  | B          |
| \![](<../../.gitbook/assets/Color Component.jpg>) | Компоненты (**Color.Components**) | color  | A, R, G, B |
...
| Значок                                                  | Имя (синтаксис)                     | Входные данные | Выходные данные    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| \![](<../../.gitbook/assets/Color Hue.jpg>)            | Оттенок (**Color.Hue**)               | color  | Hue        |
| \![](<../../.gitbook/assets/Color Saturation (1).jpg>) | Насыщенность (**Color.Saturation**) | color  | Saturation |
| \![](<../../.gitbook/assets/Color Brightness.jpg>)     | Яркость (**Color.Brightness**) | color  | Brightness |
