...
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| \![](<../images/Color byARGB.jpg>) | Цвет ARGB (**Color.ByARGB**) | A,R,G,B | color   |
...
| Значок                                             | Имя (синтаксис)                     | Входные данные | Выходные данные    |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| \![](<../images/Color Alpha.jpg>)     | Альфа (**Color.Alpha**)           | color  | A          |
| \![](<../images/Color Red.jpg>)       | Красный (**Color.Red**)               | color  | R          |
| \![](<../images/Color Green.jpg>)     | Зеленый (**Color.Green**)           | color  | G          |
| \![](<../images/Color Blue.jpg>)      | Синий (**Color.Blue**)             | color  | B          |
| \![](<../images/Color Component.jpg>) | Компоненты (**Color.Components**) | color  | A, R, G, B |
...
| Значок                                                  | Имя (синтаксис)                     | Входные данные | Выходные данные    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| \![](<../images/Color Hue.jpg>)            | Оттенок (**Color.Hue**)               | color  | Hue        |
| \![](<../images/Color Saturation.jpg>) | Насыщенность (**Color.Saturation**) | color  | Saturation |
| \![](<../images/Color Brightness.jpg>)     | Яркость (**Color.Brightness**) | color  | Brightness |
