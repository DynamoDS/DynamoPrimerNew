...
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| ![](<../images/Color byARGB.jpg>) | ARGB Color (**Color.ByARGB**) | A,R,G,B | color   |
...
| ![](<../images/Color Red.jpg>)       | Red (**Color.Red**)               | color  | R          |
| ![](<../images/Color Green.jpg>)     | Green (**Color.Green**)           | color  | G          |
| ![](<../images/Color Blue.jpg>)      | Blue (**Color.Blue**)             | color  | B          |
| ![](<../images/Color Component.jpg>) | Components (**Color.Components**) | color  | A, R, G, B |
