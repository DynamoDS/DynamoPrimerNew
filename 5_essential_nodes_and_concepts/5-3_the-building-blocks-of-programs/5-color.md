...
| ------------------------------------------------- | ------------------------------- | ------- | ------- |
| ![](<../../.gitbook/assets/Color byARGB (2).jpg>) | Couleur ARVB (**Color.ByARGB**) | A,R,G,B | color   |
...
| Icône                                                | Nom (Syntaxe)                     | Entrées | Sorties |
| ---------------------------------------------------- | --------------------------------- | ------- | ------- |
| ![](<../../.gitbook/assets/Color Alpha (2).jpg>)     | Alpha (**Color.Alpha**)           | color   | A       |
| ![](<../../.gitbook/assets/Color Red (2).jpg>)       | Rouge (**Color.Red**)             | color   | R       |
| ![](<../../.gitbook/assets/Color Green (2).jpg>)     | Vert (**Color.Green**)            | color   | G       |
| ![](<../../.gitbook/assets/Color Blue (2).jpg>)      | Bleu (**Color.Blue**)             | color   | B       |
| ![](<../../.gitbook/assets/Color Component (2).jpg>) | Composants (**Color.Components**) | color   | A,R,G,B |
...
| Icône                                                 | Nom (Syntaxe)                     | Entrées | Sorties    |
| ----------------------------------------------------- | --------------------------------- | ------- | ---------- |
| ![](<../../.gitbook/assets/Color Hue (2).jpg>)        | Teinte (**Color.Hue**)            | color   | Teinte     |
| ![](<../../.gitbook/assets/Color Saturation (2).jpg>) | Saturation (**Color.Saturation**) | color   | Saturation |
| ![](<../../.gitbook/assets/Color Brightness (2).jpg>) | Luminosité (**Color.Brightness**) | color   | Luminosité |
...
![](<../../.gitbook/assets/color - color range (1).jpg>)
...
![](<../../.gitbook/assets/color - color preview (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 01 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 02 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 03 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 04 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 05 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 06 (1).gif>)
...
![](<../../.gitbook/assets/color - basic helix with colors 07 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 08 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 09 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 10 (1).jpg>)
...
![](<../../.gitbook/assets/color - basic helix with colors 11 (1).gif>)
...
![](<../../.gitbook/assets/color - color on surface 01 (1).jpg>)
...
![](<../../.gitbook/assets/color - color on surface 02 (1).jpg>)
...
![](<../../.gitbook/assets/color - color on surface 03 (1).jpg>)
