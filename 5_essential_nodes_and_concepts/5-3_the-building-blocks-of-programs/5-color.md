...
| 아이콘                                          | 이름(구문)                 | 입력  | 출력 |
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| ![](<../images/Color byARGB.jpg>) | ARGB 색상(**Color.ByARGB**) | A,R,G,B | 색상   |
...
| 아이콘                                             | 이름(구문)                     | 입력 | 출력    |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| ![](<../images/Color Alpha.jpg>)     | 알파(**Color.Alpha**)           | 색상  | A          |
| ![](<../images/Color Red.jpg>)       | 빨간색(**Color.Red**)               | 색상  | R          |
| ![](<../images/Color Green.jpg>)     | 초록색(**Color.Green**)           | 색상  | G          |
| ![](<../images/Color Blue.jpg>)      | 파란색(**Color.Blue**)             | 색상  | B          |
| ![](<../images/Color Component.jpg>) | 구성요소(**Color.Components**) | 색상  | A,R,G,B |
...
| 아이콘                                                  | 이름(구문)                     | 입력 | 출력    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| ![](<../images/Color Hue.jpg>)            | 색조(**Color.Hue**)               | 색상  | 색조        |
| ![](<../images/Color Saturation.jpg>) | 채도(**Color.Saturation**) | 색상  | 채도 |
| ![](<../images/Color Brightness.jpg>)     | 밝기(**Color.Brightness**) | 색상  | 밝기 |
