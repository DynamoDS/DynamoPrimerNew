...
| 图标                                          | 名称（语法）                 | 输入  | 输出 |
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| \![](<../images/Color byARGB.jpg>) | ARGB 颜色 (**Color.ByARGB**) | A,R,G,B | 颜色   |
...
| 图标                                             | 名称（语法）                     | 输入 | 输出    |
| ------------------------------------------------ | --------------------------------- | ------ | ---------- |
| \![](<../images/Color Alpha.jpg>)     | Alpha (**Color.Alpha**)           | 颜色  | A          |
| \![](<../images/Color Red.jpg>)       | 红色 (**Color.Red**)               | 颜色  | R          |
| \![](<../images/Color Green.jpg>)     | 绿色 (**Color.Green**)           | 颜色  | G          |
| \![](<../images/Color Blue.jpg>)      | 蓝色 (**Color.Blue**)             | 颜色  | B          |
| \![](<../images/Color Component.jpg>) | 组件 (**Color.Components**) | 颜色  | A,R,G,B |

下表中的颜色对应于 **HSB 颜色空间**。对于我们如何解释颜色，将颜色分为色调、饱和度和亮度无疑更加直观：应该是什么颜色？应该如何呈现多彩？颜色应该如何变亮或变暗？这分别是色调、饱和度和亮度的细分。

| 图标                                                  | 名称（语法）                     | 输入 | 输出    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| \![](<../images/Color Hue.jpg>)            | 色调 (**Color.Hue**)               | 颜色  | 色调        |
| \![](<../images/Color Saturation.jpg>) | 饱和度 (**Color.Saturation**) | 颜色  | 饱和度 |
| \![](<../images/Color Brightness.jpg>)     | 亮度 (**Color.Brightness**) | 颜色  | 亮度 |
