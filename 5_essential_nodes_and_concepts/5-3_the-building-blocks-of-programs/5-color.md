...
| --------------------------------------------- | ----------------------------- | ------- | ------- |
| ![](<../images/Color byARGB.jpg>) | Couleur ARVB (**Color.ByARGB**) | A,R,G,B | color   |
...
| ![](<../images/Color Red.jpg>)       | Rouge (**Color.Red**)               | color  | R          |
| ![](<../images/Color Green.jpg>)     | Vert (**Color.Green**)           | color  | G          |
| ![](<../images/Color Blue.jpg>)      | Bleu (**Color.Blue**)             | color  | B          |
| ![](<../images/Color Component.jpg>) | Composants (**Color.Components**) | color  | A,R,G,B |
...
| Icône                                                  | Nom (Syntaxe)                     | Entrées | Sorties    |
| ----------------------------------------------------- | --------------------------------- | ------ | ---------- |
| ![](<../images/Color Hue.jpg>)            | Teinte (**Color.Hue**)               | color  | Teinte        |
| ![](<../images/Color Saturation.jpg>) | Saturation (**Color.Saturation**) | color  | Saturation |
| ![](<../images/Color Brightness.jpg>)     | Luminosité (**Color.Brightness**) | color  | Luminosité |
