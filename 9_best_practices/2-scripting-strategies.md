...
{% hint style="info" %} Список ресурсов, доступных в библиотеках Dynamo, см. в [Справочнике по созданию сценариев](3-scripting-reference.md) . {% endhint %}
...
> «Модули» кода из примера в [узле Python](../8\_coding\_in\_dynamo/8-3\_python/1-python.md).
>
> 1. Входные данные.
...
{% hint style="info" %} Совет. Всегда исходите из того, что пользователь может выбрать любую комбинацию с любым доступным входным значением. Это поможет избежать неприятных сюрпризов. {% endhint %} 
...
> Отладка файла примера из [узла Python](../8\_coding\_in\_dynamo/8-3\_python/1-python.md).
>
