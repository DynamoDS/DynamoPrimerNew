...
> Moduly kódu z příkladu v [uzlu jazyka Python](../8_coding_in_dynamo/8-3_python/1-python.md).
>
> 1. Vstupy.
...
> Ladění vzorového souboru z [uzlu jazyka Python](../8_coding_in_dynamo/8-3_python/1-python.md).
>
