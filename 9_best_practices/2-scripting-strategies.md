...
> „Moduły” kodu z przykładu w artykule [Węzeł Python](../8\_coding\_in\_dynamo/8-3\_python/1-python.md).
>
> 1. Wejścia.
...
> Debugowanie przykładowego pliku z artykułu [Węzeł Python](../8\_coding\_in\_dynamo/8-3\_python/1-python.md).
>
