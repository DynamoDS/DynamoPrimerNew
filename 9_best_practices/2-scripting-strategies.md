...
> «Модули» кода из примера в [узле Python](../8_coding_in_dynamo/8-3_python/1-python.md).
>
> 1. Входные данные.
...
> Отладка файла примера из [узла Python](../8_coding_in_dynamo/8-3_python/1-python.md).
>
