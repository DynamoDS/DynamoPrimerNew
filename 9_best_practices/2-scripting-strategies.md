...
{% hint style="info" %}
Dica: Sempre presuma que o usuário utilizará todas as combinações de valores de entrada que foram expostas a ele. Isso ajudará a eliminar surpresas indesejadas.
{% endhint %}
