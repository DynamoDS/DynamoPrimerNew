...
{% hint style="info" %}
Refer to [Scripting Reference](3-scripting-reference.md) for a list of what each Dynamo library gives you access to.
{% endhint %}
...
> The code "modules" from the example in [Python Node](../8\_coding\_in\_dynamo/8-3\_python/1-python.md).
>
> 1. Inputs.
...
> Debugging the example file from [Python Node](../8\_coding\_in\_dynamo/8-3\_python/1-python.md).
>
