...
|                    |             |               |                    |                    |               |
| ------------------ | ----------- | ------------- | ------------------ | ------------------ | ------------- |
|                    | **организация циклов;** | **использование рекурсии;** | **Сжатие узлов** | **Внешн. Библиотеки** | **Сокращение** |
...
> «Модули» кода из примера в разделе [Узел Python](http://primer.dynamobim.org/en/09\_Custom-Nodes/9-4\_Python.html).
>
> 1. Входные данные.
...
> Отладка файла примера из раздела [Узел Python](http://primer.dynamobim.org/en/09\_Custom-Nodes/9-4\_Python.html).
>
...
Теперь, когда все агенты полностью обновлены, получим соответствующую им геометрию. После того как все агенты достигнут предельного значения спуска или максимального количества шагов, следует создать сложную кривую (PolyCurve), проходящую через точки в списке их маршрутов, и выведем маршруты сложной кривой.
