...
> El código "modules" del ejemplo de [nodo de Python](../8_coding_in_dynamo/8-3_python/1-python.md).
>
> 1. Entradas.
...
> Depuración del archivo de ejemplo del [nodo de Python](../8_coding_in_dynamo/8-3_python/1-python.md).
>
