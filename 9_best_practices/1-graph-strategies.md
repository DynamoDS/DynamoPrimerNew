...
>
> List@Level 機能の使用方法については、「[リストのリスト](http://primer.dynamobim.org/en/06\_Designing-with-Lists/6-3\_lists-of-lists.html#list@level)」を参照してください。
...
>
> ノートの追加方法については、「[プログラムを管理する](http://primer.dynamobim.org/en/03\_Anatomy-of-a-Dynamo-Definition/3-4\_best\_practices.html)」を参照してください。
