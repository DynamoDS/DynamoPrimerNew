...
![群組](images/cad-chart-visual.jpg)
...
建置視覺指令碼時，請務必確認所傳回的與您所預期的相符。並非所有錯誤或問題都會導致程式立即失敗，尤其是可能會影響下游較遠處的 null 或零值。[指令碼撰寫策略](2-scripting-strategies.md)中，對文字指令碼撰寫的討論也會提及此策略。以下練習將有助於確保您獲得預期的內容。
