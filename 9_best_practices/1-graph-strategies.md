...
![группы](../.gitbook/assets/cad-chart-visual.jpg)
...
>
> Сведения о работе с элементами Code Block см. в разделе [Что такое Code Block](../8_coding_in_dynamo/8-1_code-blocks-and-design-script/1-what-is-a-code-block.md).
...
>
> Сведения о работе с функцией Node to Code см. в разделе [Синтаксис DesignScript](../8_coding_in_dynamo/8-1_code-blocks-and-design-script/2-design-script-syntax.md).
...
>
> Сведения о работе с узлом Watch см. в разделе [Библиотека](../3_user_interface/2-library.md).
...
>
> Сведения о работе с пользовательскими узлами см. в разделе [Введение в пользовательские узлы](../6_custom_nodes_and_packages/6-1_custom-nodes/1-introduction.md).
