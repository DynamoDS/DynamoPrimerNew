...
>
> Сведения об использовании групп см. в разделе [Управление программой](https://primer2.dynamobim.org/v/ru/9_best_practices/4-managing-your-program).
...
>
> Сведения о работе с элементами Code Block см. в разделе [Что такое Code Block](../8\_coding\_in\_dynamo/8-1\_code-blocks-and-design-script/1-what-is-a-code-block.md).
...
>
> Сведения о работе с функцией Node to Code см. в разделе [Синтаксис DesignScript](../8\_coding\_in\_dynamo/8-1\_code-blocks-and-design-script/2-design-script-syntax.md).
...
>
> Сведения о работе с функцией List@Level см. в разделе [Списки списков](https://primer2.dynamobim.org/v/ru/5_essential_nodes_and_concepts/5-4_designing-with-lists/3-lists-of-lists).
...
>
> Сведения об использовании функции выравнивания узлов см. в разделе [Управление программой](4-managing-your-program.md).
...
>
> Сведения о том, как добавить примечание, см. в разделе [Управление программой](https://primer2.dynamobim.org/v/ru/9_best_practices/4-managing-your-program).

## Зондирование на всех этапах работы

При создании визуального сценария важно убедиться в том, что возвращаемые результаты соответствуют ожидаемым. Не все ошибки или проблемы ведут к немедленному сбою в работе программы. Особенно это касается нулевых значений, которые могут повлиять на работу значительно позже. Этот метод также применяется к текстовым сценариям. См. раздел [Методы создания сценариев](2-scripting-strategies.md). Следующие рекомендации помогут получить ожидаемые результаты.
...
>
> Сведения о работе с узлом Watch см. в разделе [Библиотека](../3\_user\_interface/2-library.md).
...
> Сведения о работе с набором параметров см. в разделе [Управление данными с помощью наборов параметров](1-graph-strategies.md#use-presets-to-embed-input-values).
...
>
> Сведения о работе с пользовательскими узлами см. в разделе [Введение в пользовательские узлы](../6\_custom\_nodes\_and\_packages/6-1\_custom-nodes/1-introduction.md).
