...
> Download the example file that accompanies this exercise (Right click and "Save Link As..."): [List-Operations.dyn](https://github.com/h-iL/ForkedDynamoPrimerReorganized/blob/main/06\_Designing-with-Lists/datasets/6-2/List-Operations.dyn). A full list of example files can be found in the Appendix.

![Exercise](../../.gitbook/assets/40.jpg)
...
1. Plug the code block from the previous step into the _param_ input of two _Curve.PointAtParameter_ nodes. Plug _Circle.ByPlaneRadius_ into the curve input of the top node, and _Geometry.Translate_ into the curve input of the node beneath it.
2. Using a _Line.ByStartPointEndPoint_, connect the two \*Curve.PointAtParameter \*nodes.

![Exercise](../../.gitbook/assets/38.jpg)
...
\###List.GetItemAtIndex ![index](../../.gitbook/assets/index.jpg)
...
![Exercise](../../.gitbook/assets/33.jpg)

> 1. Using the _List.GetItemAtIndex_ node, we are selecting index _"0"_, or the first item in the list of lines.

1. The _Watch3D_ node reveals that we've selected one line. Note: to get the image above, be sure to disable the preview of _Line.ByStartPointEndPoint_.

\###List.Reverse ![reverse](../../.gitbook/assets/reverse.jpg)
