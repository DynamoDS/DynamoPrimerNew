...
![Exercise](<../.gitbook/assets/00 (3).jpg>)

> 1. Beginning by selecting two edges with the _"Select Edge"_ node. The two edges are the long spans of the atrium.

1. Combine the two edges into one list with the _List.Create_ node.
2. Create a surface between the two edges with a _Surface.ByLoft_.

![Exercise](<../.gitbook/assets/01 (11).jpg>)
