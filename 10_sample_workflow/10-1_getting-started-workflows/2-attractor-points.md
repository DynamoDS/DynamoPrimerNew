...
> 3. Geometria > Pontos > Ponto > **By Coordinates(x,y,z)**
...
> 1. Adicionar um nó **Number Sequence** e substituir as entradas de **Point.ByCoordinates**: clique com o botão direito do mouse em Point.ByCoordinates e selecione Amarra > Referência cruzada
> 2. Adicione um nó **Flatten** após Point.ByCoordinates. Para aplainar uma lista completamente, deixe a entrada `amt` com o padrão `-1`
