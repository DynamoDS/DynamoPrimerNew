...
Usaremos uma metodologia semelhante para definir o nosso vaso. Vamos criar quatro círculos com diferentes alturas e raios e depois uma superfície elevando esses círculos.
...
Vamos também alterar o nome do **Controle deslizante de número** para “Raio superior”, clicando duas vezes no nome do nó.
...
Também vamos desativar a visualização em outros nós para mostrar somente a exibição **Surface.ByLoft**.
